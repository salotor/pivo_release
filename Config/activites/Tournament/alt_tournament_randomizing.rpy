...
# -----------------------------------------------------------------------------------------------
    alt_table_mutual_taunt = {
        ...
        "mi+mz":    "Женя взглянула на свою оппонентку, сокрушённо вздохнула, и села напротив.",    # Мику + Женя
...
# -----------------------------------------------------------------------------------------------
    alt_table_gamblers_winner_final = {
        ...
        "un":   [           # Лена
                    [None, "Пребывавшая в лёгком шоке Лена вздрогнула от неожиданности, услышав своё имя."]
                ],
        "sl":   [           # Славя
