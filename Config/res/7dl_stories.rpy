...
label alt_stories_start:
    ...
    if (not sdl_mus_engine.is_active) and (renpy.music.get_playing(channel="music") != default_7dl_path + "Sound/music/breath_again_7dl.ogg"):
...
screen road_main_7dl:
    ...
    textbutton "Фанфики по 7дл":
        ...
        xmaximum 0.25
        action ShowTransient("road_fanfics_1_7dl", transition=Dissolve(0.2))
    $ alt_pos += 1
...
screen road_fanfics_1_7dl:
    ...
    imagebutton:
        ...
        action [Hide("road_fanfics_1_7dl", transition=Dissolve(0.2)), ShowTransient("road_fanfics_2_7dl", transition=Dissolve(0.2))]
    $ alt_pos = 1
    textbutton "Кошкорут (Кошкотим)":
        ...
        ypos 0.138+0.0485*alt_pos
        xmaximum 0.25
        action [Hide("stories_main_7dl", transition=Dissolve(0.2)), Stop('music', fadeout=1), SetField(sdl_mus_engine, "is_active", False), Start("alt_day4_start_uvao") if persistent.pivo_default_7dl else Jump("alt_day4_start_uvao")]
    $ alt_pos += 1
...
screen road_fanfics_2_7dl:
    tag list
    imagebutton:
        auto get_image_7dl("gui/stories/repl/buttons/repl_arrow_left_%s.png") xcenter 0.554 ycenter 0.923
        activate_sound repl_page_turnings[str(random.choice([1, 2, 3, 4, 5]))]
        action [Hide("road_fanfics_2_7dl", transition=Dissolve(0.2)), ShowTransient("road_fanfics_1_7dl", transition=Dissolve(0.2))]
    $ alt_pos = 1
    textbutton "Мой Сычик (Broni)":
        style "log_button"
        text_style "old_road_textbutton"
        xpos 0.534
        ypos 0.138+0.0485*alt_pos
        xmaximum 0.25
        action [Hide("stories_main_7dl", transition=Dissolve(0.2)), Stop('music', fadeout=1), SetField(sdl_mus_engine, "is_active", False), Start("sl_sychik") if persistent.pivo_default_7dl else Jump("sl_sychik")]
    $ alt_pos += 1
...
screen old_ends_7dl:
    ...
    $ alt_pos += 1
    textbutton "Прочие концовки":
        style "log_button"
        text_style "old_road_textbutton"
        xpos 0.534
        ypos 0.138+0.0485*alt_pos
        xmaximum 0.25
        action [Hide("old_ends_7dl", transition=Dissolve(0.2)), ShowTransient("old_ends_other_7dl", transition=Dissolve(0.2))]
    $ alt_pos += 1
...
screen old_ends_mi_7dl:
    ...
    $ alt_pos += 1
    textbutton "Можно? (старая версия)":
        style "log_button"
        text_style "old_road_textbutton"
        xpos 0.534
        ypos 0.138+0.0485*alt_pos
        xmaximum 0.25
        action [Hide("stories_main_7dl", transition=Dissolve(0.2)), Stop('music', fadeout=1), SetField(sdl_mus_engine, "is_active", False), Start("alt_day7_mi_7dl_vatashi") if persistent.pivo_default_7dl else Jump("alt_day7_mi_7dl_vatashi")]
    $ alt_pos += 1
...
# Прочие концовки
screen old_ends_other_7dl:
    tag list
    $ alt_pos = 1
    textbutton "Старый бэд Одиночки":
        style "log_button"
        text_style "old_road_textbutton"
        xpos 0.534
        ypos 0.138+0.0485*alt_pos
        xmaximum 0.25
        action [Hide("stories_main_7dl", transition=Dissolve(0.2)), Stop('music', fadeout=1), SetField(sdl_mus_engine, "is_active", False), Start("alt_day7_me_neu_bad_old") if persistent.pivo_default_7dl else Jump("alt_day7_me_neu_bad_old")]
    $ alt_pos += 1
    textbutton "Старый нейтрал Локи":
        style "log_button"
        text_style "old_road_textbutton"
        xpos 0.534
        ypos 0.138+0.0485*alt_pos
        xmaximum 0.25
        action [Hide("stories_main_7dl", transition=Dissolve(0.2)), Stop('music', fadeout=1), SetField(sdl_mus_engine, "is_active", False), Start("alt_day7_me_neu_loki_neu_old") if persistent.pivo_default_7dl else Jump("alt_day7_me_neu_loki_neu_old")]
    $ alt_pos += 1
    textbutton "Старый нейтрал Дрища":
        style "log_button"
        text_style "old_road_textbutton"
        xpos 0.534
        ypos 0.138+0.0485*alt_pos
        xmaximum 0.25
        action [Hide("stories_main_7dl", transition=Dissolve(0.2)), Stop('music', fadeout=1), SetField(sdl_mus_engine, "is_active", False), Start("alt_day7_me_neu_dr_neu_old") if persistent.pivo_default_7dl else Jump("alt_day7_me_neu_dr_neu_old")]
    $ alt_pos += 1
    textbutton "Старый бэд Ульяны":
        style "log_button"
        text_style "old_road_textbutton"
        xpos 0.534
        ypos 0.138+0.0485*alt_pos
        xmaximum 0.25
        action [Hide("stories_main_7dl", transition=Dissolve(0.2)), Stop('music', fadeout=1), SetField(sdl_mus_engine, "is_active", False), Start("alt_day7_us_7dl_verses2") if persistent.pivo_default_7dl else Jump("alt_day7_us_7dl_verses2")]
    $ alt_pos += 1
    textbutton "Когда-то здесь было тихо (реджект Лены-7дл)":
        style "log_button"
        text_style "old_road_textbutton"
        xpos 0.534
        ypos 0.138+0.0485*alt_pos
        xmaximum 0.25
        action [Hide("stories_main_7dl", transition=Dissolve(0.2)), Stop('music', fadeout=1), SetField(sdl_mus_engine, "is_active", False), Start("alt_day7_un_7dl_rej_old") if persistent.pivo_default_7dl else Jump("alt_day7_un_7dl_rej_old")]
...
screen unreleased_2_7dl:
    ...
    $ alt_pos += 1
    textbutton "Удалённые сцены из инт-ветки Слави-классик":
        style "log_button"
        text_style "old_road_textbutton"
        xpos 0.534
        ypos 0.138+0.0485*alt_pos
        xmaximum 0.25
        action [Hide("stories_main_7dl", transition=Dissolve(0.2)), Stop('music', fadeout=1), SetField(sdl_mus_engine, "is_active", False), Start("alt_day6_sl_cl_narcomania") if persistent.pivo_default_7dl else Jump("alt_day6_sl_cl_narcomania")]
    $ alt_pos += 2
    # textbutton "Удалённые сцены из Алисы-7дл":
        # style "log_button"
        # text_style "old_road_textbutton"
        # xpos 0.534
        # ypos 0.138+0.0485*alt_pos
        # xmaximum 0.25
        # action [Hide("stories_main_7dl", transition=Dissolve(0.2)), Stop('music', fadeout=1), SetField(sdl_mus_engine, "is_active", False), Start("alt_day3_dv_7dl_old") if persistent.pivo_default_7dl else Jump("alt_day3_dv_7dl_old")]
    # $ alt_pos += 2
