...
init 2 python:
    ...
    sdl_mus_engine = sdl_mus_Engine((len(music_list_7dl) - len(music_list_excluded_7dl) - 1) // SDL_MUS_PAGE_SIZE + 1)
...
screen music_7dl(default_music, engine=sdl_mus_engine):
    modal True
...
screen music_panel_7dl(default_music, engine=sdl_mus_engine):
    modal True
