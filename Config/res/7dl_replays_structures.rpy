init 9999 python:
    ...
    sdl_repl_array_common_day2 = [
        ...
        sdl_repl_Label(
            "Расплата",
            sdl_Replay(
                        "alt_day2_run", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_b_d2_us_esca
                                ],
                        func_in = sunset_interface_on, func_out = replay_screens_load
    ...
    sdl_repl_array_common_day3 = [
        ...
        sdl_repl_Label(
            "Перед медпунктом",
            sdl_Replay(
                        "alt_day3_pre_med_un", {"alt_replay_on" : "True"},
                        vars = [],
                        func_in = sunset_interface_on, func_out = replay_screens_load
                      ),
        ),
        ...
        sdl_repl_Label(
            "Ссора с Алисой",
            sdl_Replay(
                        "alt_day3_dv_dance_2", {"alt_replay_on" : "True"},
                        music = music_list["raindrops"],
                        func_in = night_interface_on, func_out = replay_screens_load
                      )
        ),
        sdl_repl_Label(
    ...
    ## Мику
    ### Мику-7дл
    sdl_repl_array_mi_7dl_start = [
        sdl_repl_Label(
            "Selector",
            sdl_Replay(
                        "alt_day4_mi_7dl_start", {"alt_selector" : "True"},
                        vars = [
                        ...
                        func_in = None, func_out = sdl_stories_return
                      )
        )
    ]
    #### 4 День
    ...
    sdl_repl_array_mi_7dl_day5 = [
        ...
        sdl_repl_Label(
            "Баня",
            sdl_Replay(
                        "alt_day5_mi_7dl_lost", {"alt_replay_on" : "True"},
                        vars = [
    ...
    ### Мику-Диджей
    sdl_repl_array_mi_djt_start = [
        sdl_repl_Label(
            "Selector",
            sdl_Replay(
                        "alt_day4_mi_dj_start", {"alt_selector" : "True", "routetag" : "mi7dl"},
                        vars = [
                                    sdl_var_b_d2_me_mini,
                                    sdl_var_b_d2_mt_help,
                                    sdl_var_b_d2_us_dubs,
    ...
    ## Алиса
    ### Алиса-7дл
    sdl_repl_array_dv_7dl_start = [
        sdl_repl_Label(
            "Selector",
            sdl_Replay(
                        "alt_day4_dv_7dl_start", {"alt_selector" : "True", "routetag" : "dv7dl"},
                        vars = [
                                    sdl_var_b_d1_us_shot,
                                    sdl_var_b_d2_me_mini,
                                    sdl_var_b_d2_us_esca,
    ...
    ### Алиса-Диджей
    sdl_repl_array_dv_djt_start = [
        sdl_repl_Label(
            "Selector",
            sdl_Replay(
                        "alt_day4_dv_dj_start", {"alt_selector" : "True"},
                        vars = [
    ...
    sdl_repl_array_dv_djt_day6 = [
        ...
        sdl_repl_Label(
            "Квест. Гирлянды",
            sdl_Replay(
                        "alt_day6_dv_dj_quest_garlands", {"alt_replay_on" : "True"},
                        music = music_list["everyday_theme"],
                        vars = [
                                    sdl_var_e_d5_dv_dj_mapp
                                ],
        ...
        sdl_repl_Label(
            "Квест. Стенды",
            sdl_Replay(
                        "alt_day6_dv_dj_quest_newspapers", {"alt_replay_on" : "True"},
                        music = music_list["everyday_theme"],
                        func_in = day_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 1
        ...
        sdl_repl_Label(
            "Квест. Склад",
            sdl_Replay(
                        "alt_day6_dv_dj_quest_warehouse", {"alt_replay_on" : "True"},
                        music = music_list["everyday_theme"],
                        vars = [
                                    sdl_var_e_d1_sl_key,
        ...
        sdl_repl_Label(
            "Квест. Костюмы",
            sdl_Replay(
                        "alt_day6_dv_dj_quest_costumes", {"alt_replay_on" : "True"},
                        music = music_list["everyday_theme"],
                        vars = [
                                    sdl_var_i_dv_dj_secr
                                ],
                        func_in = day_interface_on, func_out = replay_screens_load
                      )
        ),
        sdl_repl_Label(
            "Квест. Отлыниваем",
            sdl_Replay(
                        "alt_day6_dv_dj_quest_slacker", {"alt_replay_on" : "True"},
                        music = music_list["everyday_theme"],
                        func_in = day_interface_on, func_out = replay_screens_load
                      )
        ),
        ...
        sdl_repl_Label(
            "Лена. Сложившийся пазл",
            sdl_Replay(
                        "alt_day6_dv_dj_un_night_true", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_i_dv_lpp
                                ],
                        func_in = night_interface_on, func_out = replay_screens_load
        ...
        sdl_repl_Label(
            "Лена. Надежда",
            sdl_Replay(
                        "alt_day6_dv_dj_un_night_good", {"alt_replay_on" : "True"},
                        func_in = night_interface_on, func_out = replay_screens_load
                      )
        ),
        sdl_repl_Label(
            "Лена. Смирение",
            sdl_Replay(
                        "alt_day6_dv_dj_un_night_neu", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_e_d5_dv_dj_mapp
                                ],
                        func_in = night_interface_on, func_out = replay_screens_load
        ...
        sdl_repl_Label(
            "Лена. Ссора",
            sdl_Replay(
                        "alt_day6_dv_dj_un_night_bad", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_e_d5_dv_dj_mapp
                                ],
                        func_in = night_interface_on, func_out = replay_screens_load
        ...
        sdl_repl_Label(
            "Лена. Насилие",
            sdl_Replay(
                        "alt_day6_dv_dj_un_night_loki_bad", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_e_d5_dv_dj_mapp
                                ],
                        func_in = night_interface_on, func_out = replay_screens_load
    ...
    sdl_repl_array_dv_djt_day7 = [
        sdl_repl_Label(
            "Сон. Истина",
            sdl_Replay(
                        "alt_day7_dv_dj_dream_true", {"alt_replay_on" : "True"},
                        func_in = night_interface_on, func_out = replay_screens_load
                      )
        ),
        sdl_repl_Label(
            "Сон. Алиса",
            sdl_Replay(
                        "alt_day7_dv_dj_dream_good", {"alt_replay_on" : "True"},
                        func_in = night_interface_on, func_out = replay_screens_load
                      )
        ),
        sdl_repl_Label(
            "Сон. Разлад",
            sdl_Replay(
                        "alt_day7_dv_dj_dream_bad", {"alt_replay_on" : "True"},
                        func_in = night_interface_on, func_out = replay_screens_load
                      )
        ),
        sdl_repl_Label(
            "Утро. К Алисе",
            sdl_Replay(
                        "alt_day7_dv_dj_morning_good", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_e_d6_dv_dj_ends
                                ],
                        func_in = day_interface_on, func_out = replay_screens_load
        ...
        sdl_repl_Label(
            "Утро. Нерешительность",
            sdl_Replay(
                        "alt_day7_dv_dj_morning_neu", {"alt_replay_on" : "True"},
                        func_in = day_interface_on, func_out = replay_screens_load
                      )
        ),
        sdl_repl_Label(
            "Утро. Дома",
            sdl_Replay(
                        "alt_day7_dv_dj_morning_bad", {"alt_replay_on" : "True"},
                        func_in = day_interface_on, func_out = replay_screens_load
                      )
        ),
        sdl_repl_Label(
            "Алиса. Истина",
            sdl_Replay(
                        "alt_day7_dv_dj_points_true", {"alt_replay_on" : "True"},
                        func_in = day_interface_on, func_out = replay_screens_load
                      )
        ),
        sdl_repl_Label(
            "Алиса. Примирение",
            sdl_Replay(
                        "alt_day7_dv_dj_points_good", {"alt_replay_on" : "True"},
                        func_in = day_interface_on, func_out = replay_screens_load
                      )
        ),
        sdl_repl_Label(
            "Алиса. Расставание",
            sdl_Replay(
                        "alt_day7_dv_dj_points_bad", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_e_d6_dv_dj_ends
                                ],
                        func_in = day_interface_on, func_out = replay_screens_load
    ...
    ## Славя
    ### Славя-7дл
    sdl_repl_array_sl_7dl_start = [
        sdl_repl_Label(
            "Selector",
            sdl_Replay(
                        "alt_day4_sl_7dl_start", {"alt_selector" : "True"},
                        vars = [
                                    sdl_var_b_d2_me_mini,
                                    sdl_var_b_d2_us_dubs,
                                    sdl_var_e_d0_char,
    ...
    ### Славя-Классик
    sdl_repl_array_sl_clt_start = [
        sdl_repl_Label(
            "Selector",
            sdl_Replay(
                        "alt_day4_sl_cl_start", {"alt_selector" : "True", "routetag" : "sl"},
                        vars = [
                                    sdl_var_b_d2_dv_hous,
                                    sdl_var_b_d2_mi_snap,
                                    sdl_var_e_d0_char,
    ...
    ## Лена
    ### Лена-7дл
    sdl_repl_array_un_7dl_start = [
        sdl_repl_Label(
            "Selector",
            sdl_Replay(
                        "alt_day4_un_7dl_start", {"alt_selector" : "True", "routetag" : "un7dl"},
                        vars = [
                                    sdl_var_b_d1_el_foll,
                                    sdl_var_b_d2_us_esca,
                                    sdl_var_b_d3_me_duty,
    ...
    sdl_repl_array_un_7dl_day5 = [
        ...
        sdl_repl_Label(
            "«Лиловый шар»",
            sdl_Replay(
                        "alt_day5_un_7dl_cinema", {"alt_replay_on" : "True"},
    ...
    sdl_repl_array_un_7dl_day7 = [
        ...
        sdl_repl_Label(
            "Пробуждение",
            sdl_Replay(
                        "alt_day7_un_7dl_wakeup", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_e_d1_sl_key,
                                    sdl_var_l_d2_club
                                ],
        ...
        sdl_repl_Label(
            "Дрищ. День в стенгазете",
            sdl_Replay(
                        "alt_day7_un_7dl_dr_nwsppr_day", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_b_d6_un_7dl_ussr
                                ],
                        func_in = day_interface_on, func_out = replay_screens_load
                      )
        ),
        sdl_repl_Label(
            "Локи. День в клубах",
            sdl_Replay(
                        "alt_day7_un_7dl_loki_keys_day", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_b_d6_un_7dl_ussr
                                ],
                        func_in = day_interface_on, func_out = replay_screens_load
        ...
        sdl_repl_Label(
            "День",
            sdl_Replay(
                        "alt_day7_un_7dl_day_default", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_b_d6_un_7dl_ussr
                                ],
                        func_in = day_interface_on, func_out = replay_screens_load
        ...
        sdl_repl_Label(
            "Сборы",
            sdl_Replay(
                        "alt_day7_un_7dl_packing", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_b_d6_un_7dl_ussr,
                                    sdl_var_i_un_7dl_rnm
                                ],
                        func_in = day_interface_on, func_out = replay_screens_load
                      )
        ),
        sdl_repl_Label(
            "День. Проспал",
            sdl_Replay(
                        "alt_day7_un_7dl_day_late", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_e_d1_sl_key,
                                    sdl_var_e_d4_me_neu_tran
                                ],
        ...
        sdl_repl_Label(
            "Таблетки",
            sdl_Replay(
                        "alt_day7_un_7dl_pills", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_e_d4_me_neu_tran
                                ],
                        func_in = night_interface_on, func_out = replay_screens_load)
        ...
        sdl_repl_Label(
            "Откат",
            sdl_Replay(
                        "alt_day7_un_7dl_rollback", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_e_d4_me_neu_tran
                                ],
                        func_in = day_interface_on, func_out = replay_screens_load)
    ...
    ### Лена-Френдзона
    sdl_repl_array_un_fzd_start = [
        sdl_repl_Label(
            "Selector",
            sdl_Replay(
                        "alt_day4_un_fz_start_new", {"alt_selector" : "True", "routetag" : "un7dl", "cur_char" : "herc"},
                        vars = [
                                    sdl_var_b_d2_dv_hous,
                                    sdl_var_b_d3_un_fz_stories,
    ...
    sdl_repl_array_un_fzd_day7 = [
        ...
        sdl_repl_Label(
            "Похороны Пирата",
            sdl_Replay(
                        "alt_day7_un_fz_neu_pirate", {"alt_replay_on" : "True"},
                        music = music_list["everyday_theme"],
                        ambience = ambience_camp_center_day,
                        vars = [
                                    sdl_var_e_d6_un_fz_map2,
        ...
        sdl_repl_Label(
            "Прогулка с Ольгой",
            sdl_Replay(
                        "alt_day7_un_fz_neu_mt", {"alt_replay_on" : "True"},
                        music = music_list["everyday_theme"],
                        ambience = ambience_camp_center_day,
                        vars = [
                                    sdl_var_e_d6_un_fz_map2,
    ...
    ## Ольга
    ### Ольга-7дл
    sdl_repl_array_mt_7dl_start = [
        sdl_repl_Label(
            "Selector",
            sdl_Replay(
                        "alt_day6_mt_7dl_start", {"alt_selector" : "True"},
                        vars = [
    ...
    ## Ульяна
    ### Ульяна-7дл
    sdl_repl_array_us_7dl_start = [
        sdl_repl_Label(
            "Selector",
            sdl_Replay(
                        "alt_day6_us_7dl_start", {"alt_selector" : "True"},
                        vars = [
                                    sdl_var_b_d2_mi_snap,
                                    sdl_var_b_d2_us_esca,
                                    sdl_var_b_d3_me_tec2,
                                    sdl_var_b_d4_me_neu_esca,
    ...
    ## Одиночка
    ### Одиночка
    sdl_repl_array_me_neu_start = [
        sdl_repl_Label(
            "Selector",
            sdl_Replay(
                        "alt_day4_me_neu_start", {"alt_selector" : "True"},
                        vars = [
                                    sdl_var_b_d2_dv_hous,
                                    sdl_var_b_d2_me_beac,
                                    sdl_var_b_d2_me_mini,
                                    sdl_var_b_d2_mi_snap,
                                    sdl_var_b_d2_mt_help,
    ...
    sdl_repl_array_me_neu_day6 = [
        ...
        sdl_repl_Label(
            ...
            sdl_Replay(
                        ...
                        music = music_7dl["lonesome_shepherd"],
                        vars = [
                                    sdl_var_e_d6_me_neu_danc
                                ],
                        func_in = night_interface_on, func_out = replay_screens_load
        ...
        sdl_repl_Label(
            "Танец с Ульяной",
            sdl_Replay(
                        "alt_day6_me_neu_us_dance", {"alt_replay_on" : "True"},
                        music = music_7dl["lonesome_shepherd"],
                        ambience = ambience_camp_center_night,
                        vars = [
                                    sdl_var_b_d5_me_neu_cs_debt
        ...
        sdl_repl_Label(
            "Дискотека с Женей",
            sdl_Replay(
                        "alt_day6_me_neu_mz_dance", {"alt_replay_on" : "True"},
                        music = music_7dl["lonesome_shepherd"],
                        ambience = ambience_camp_center_night,
                        func_in = night_interface_on, func_out = replay_screens_load
                      )
        ...
        sdl_repl_Label(
            "Танец с Катюшкой",
            sdl_Replay(
                        "alt_day6_me_neu_ka_dance", {"alt_replay_on" : "True"},
                        music = music_7dl["lonesome_shepherd"],
                        ambience = ambience_camp_center_night,
                        vars = [
                                    sdl_var_b_d4_me_neu_cs_debt
    ...
    #### 7 День
    sdl_repl_array_me_neu_day7 = [
        sdl_repl_Label(
            "Пробуждение",
            sdl_Replay(
                        "alt_day7_me_neu_begin", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_e_d6_me_neu_danc,
                                    sdl_var_i_mz_7dl,
                                    sdl_var_i_mt_7dl,
        ...
        sdl_repl_Label(
            "Завтрак с кибернетиками",
            sdl_Replay(
                        "alt_day7_me_neu_el_breakfast", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_i_me_neu_answ,
                                    sdl_var_i_sl_clt
                                ],
        ...
        sdl_repl_Label(
            "Завтрак с Женей",
            sdl_Replay(
                        "alt_day7_me_neu_mz_breakfast", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_i_sl_7dl
                                ],
                        func_in = sunset_interface_on, func_out = replay_screens_load
        ...
        sdl_repl_Label(
            "Завтрак в одиночку",
            sdl_Replay(
                        "alt_day7_me_neu_alone_breakfast", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_e_d6_me_neu_map,
                                    sdl_var_e_d6_me_neu_danc,
                                    sdl_var_i_mt_7dl,
                                    sdl_var_i_sl_clt,
                                    sdl_var_b_d4_me_neu_mi_club,
                                    sdl_var_b_d5_me_neu_mi_help,
                                    sdl_var_b_d5_me_neu_sprt,
                                    sdl_var_b_d4_me_neu_ba_duty,
                                    sdl_var_b_d4_me_neu_us_debt,
                                    sdl_var_b_d5_me_neu_cybr,
        ...
        sdl_repl_Label(
            "Награждение",
            sdl_Replay(
                        "alt_day7_me_neu_ceremony", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_e_d6_me_neu_danc,
                                    sdl_var_i_me_neu_answ,
                                    sdl_var_i_sl_clt,
        ...
        sdl_repl_Label(
            "Сборы с Мику",
            sdl_Replay(
                        "alt_day7_me_neu_mi_fees", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_b_d4_me_neu_mi_club,
                                    sdl_var_b_d5_me_neu_mi_help,
                                    sdl_var_e_d6_me_neu_map,
        ...
        sdl_repl_Label(
            "Сборы с Алисой",
            sdl_Replay(
                        "alt_day7_me_neu_dv_fees", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_b_d2_me_mini,
                                    sdl_var_b_d7_me_neu_ceremon,
                                    sdl_var_e_d3_dj,
                                    sdl_var_e_d3_me_dan2,
                                    sdl_var_i_dv_7dl,
                                    sdl_var_e_d5_me_neu_mapi
        ...
        sdl_repl_Label(
            "Сборы со Славей",
            sdl_Replay(
                        "alt_day7_me_neu_sl_fees", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_b_d7_me_neu_ceremon,
                                    sdl_var_e_d4_me_neu_date
                                ],
        ...
        sdl_repl_Label(
            "Истории о Лене",
            sdl_Replay(
                        "alt_day7_me_neu_un_fees", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_b_d7_me_neu_ceremon,
                                    sdl_var_e_d2_date
                                ],
        ...
        sdl_repl_Label(
            "Сборы с Ульяной",
            sdl_Replay(
                        "alt_day7_me_neu_us_fees", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_b_d7_me_neu_ceremon
                                ],
                        func_in = day_interface_on, func_out = replay_screens_load
        ...
        sdl_repl_Label(
            "Сборы в одиночку",
            sdl_Replay(
                        "alt_day7_me_neu_alone_fees", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_b_d7_me_neu_ceremon,
                                    sdl_var_b_d4_me_neu_voll,
                                    sdl_var_b_d3_me_duty,
        ...
        sdl_repl_Label(
            "Отъезд",
            sdl_Replay(
                        "alt_day7_me_neu_departure", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_e_d6_me_neu_danc,
                                    sdl_var_i_mt_7dl,
                                    sdl_var_i_mz_7dl,
    ...
    #### 6 День. Ответы
    sdl_repl_array_me_neu_day6_answ = [
        sdl_repl_Label(
            "Утро. Герк",
            sdl_Replay(
                        "alt_day6_me_neu_begin_answ_h", {"alt_replay_on" : "True"},
                        func_in = sunset_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 2
        ),
        sdl_repl_Label(
            "Завтрак. Герк",
            sdl_Replay(
                        "alt_day6_me_neu_breakfast_answ_h", {"alt_replay_on" : "True"},
                        func_in = sunset_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 2
        ),
        sdl_repl_Label(
            "День. Герк",
            sdl_Replay(
                        "alt_day6_me_neu_day_answ_h", {"alt_replay_on" : "True"},
                        func_in = day_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 2
        ),
        sdl_repl_Label(
            "Обед. Герк",
            sdl_Replay(
                        "alt_day6_me_neu_lunch_answ_h", {"alt_replay_on" : "True"},
                        func_in = day_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 2
        ),
        sdl_repl_Label(
            "Тихий час. Герк",
            sdl_Replay(
                        "alt_day6_me_neu_silent_hour_answ_h", {"alt_replay_on" : "True"},
                        func_in = day_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 2
        ),
        sdl_repl_Label(
            "Побег. Герк",
            sdl_Replay(
                        "alt_day6_me_neu_escape_answ_h", {"alt_replay_on" : "True"},
                        vars = [
                                sdl_var_e_d1_sl_key
                                ],
                        func_in = day_interface_on, func_out = replay_screens_load
        ...
        sdl_repl_Label(
            "Ужин. Герк",
            sdl_Replay(
                        "alt_day6_me_neu_dinner_answ_h", {"alt_replay_on" : "True"},
                        func_in = sunset_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 2
        ),
        sdl_repl_Label(
            "Желание. Герк",
            sdl_Replay(
                        "alt_day6_me_neu_disco_wish_answ_h", {"alt_replay_on" : "True"},
                        meets = {'uv' : 'Кошкодевочка'},
                        func_in = sunset_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 2
        ...
        sdl_repl_Label(
            "Утро. Дрищ",
            sdl_Replay(
                        "alt_day6_me_neu_begin_answ_d", {"alt_replay_on" : "True"},
                        func_in = sunset_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 1
        ),
        sdl_repl_Label(
            "День. Дрищ",
            sdl_Replay(
                        "alt_day6_me_neu_day_answ_d", {"alt_replay_on" : "True"},
                        [],
                        func_in = day_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 1
        ...
        sdl_repl_Label(
            "Обед. Дрищ",
            sdl_Replay(
                        "alt_day6_me_neu_lunch_answ_d", {"alt_replay_on" : "True"},
                        [],
                        func_in = day_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 1
        ...
        sdl_repl_Label(
            "Тихий час. Дрищ",
            sdl_Replay(
                        "alt_day6_me_neu_silent_hour_answ_d", {"alt_replay_on" : "True"},
                        [],
                        func_in = day_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 1
        ...
        sdl_repl_Label(
            "Полдник. Дрищ",
            sdl_Replay(
                        "alt_day6_me_neu_afternoon_answ_d", {"alt_replay_on" : "True"},
                        [],
                        func_in = day_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 1
        ...
        sdl_repl_Label(
            "Концерт. Дрищ",
            sdl_Replay(
                        "alt_day6_me_neu_concert_answ_d", {"alt_replay_on" : "True"},
                        [],
                        func_in = day_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 1
        ...
        sdl_repl_Label(
            "Побег. Дрищ",
            sdl_Replay(
                        "alt_day6_me_neu_escape_answ_d", {"alt_replay_on" : "True"},
                        [],
                        func_in = sunset_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 1
        ...
        sdl_repl_Label(
            "Конфликт. Дрищ",
            sdl_Replay(
                        "alt_day6_me_neu_disco_answ_d", {"alt_replay_on" : "True"},
                        meets = {'uv' : 'Кошкодевочка'},
                        func_in = night_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 1
        ...
        sdl_repl_Label(
            "Утро. Локи",
            sdl_Replay(
                        "alt_day6_me_neu_begin_answ_l", {"alt_replay_on" : "True"},
                        [],
                        func_in = day_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 4
        ...
        sdl_repl_Label(
            "Завтрак. Локи",
            sdl_Replay(
                        "alt_day6_me_neu_breakfast_answ_l", {"alt_replay_on" : "True"},
                        [],
                        func_in = day_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 4
        ...
        sdl_repl_Label(
            "День. Локи",
            sdl_Replay(
                        "alt_day6_me_neu_day_answ_l", {"alt_replay_on" : "True"},
                        [],
                        func_in = day_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 4
        ...
        sdl_repl_Label(
            "Обед. Локи",
            sdl_Replay(
                        "alt_day6_me_neu_lunch_answ_l", {"alt_replay_on" : "True"},
                        [],
                        func_in = day_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 4
        ...
        sdl_repl_Label(
            "Тихий час. Локи",
            sdl_Replay(
                        "alt_day6_me_neu_silent_hour_answ_l", {"alt_replay_on" : "True"},
                        [],
                        func_in = day_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 4
        ...
        sdl_repl_Label(
            "Пристань. Локи",
            sdl_Replay(
                        "alt_day6_me_neu_silent_hour_boat_answ_l", {"alt_replay_on" : "True"},
                        [],
                        func_in = day_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 4
        ...
        sdl_repl_Label(
            "Полдник. Локи",
            sdl_Replay(
                        "alt_day6_me_neu_afternoon_answ_l", {"alt_replay_on" : "True"},
                        [],
                        func_in = day_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 4
        ...
        sdl_repl_Label(
            "Концерт. Локи",
            sdl_Replay(
                        "alt_day6_me_neu_concert_answ_l", {"alt_replay_on" : "True"},
                        [],
                        func_in = day_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 4
        ...
        sdl_repl_Label(
            "Ужин. Локи",
            sdl_Replay(
                        "alt_day6_me_neu_dinner_answ_l", {"alt_replay_on" : "True"},
                        [],
                        func_in = sunset_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 4
        ...
        sdl_repl_Label(
            "Надежда. Локи",
            sdl_Replay(
                        "alt_day6_me_neu_disco_answ_l", {"alt_replay_on" : "True"},
                        [],
                        func_in = night_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 4
        ...
        sdl_repl_Label(
            "Побег. Локи",
            sdl_Replay(
                        "alt_day6_me_neu_escape_answ_l", {"alt_replay_on" : "True"},
                        [],
                        func_in = night_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 4
        ...
        sdl_repl_Label(
            "Старая Дорога. Локи",
            sdl_Replay(
                        "alt_day6_me_neu_oldroad_answ_l", {"alt_replay_on" : "True"},
                        meets = {'uv' : 'Кошкодевочка'},
                        func_in = prolog_interface_on, func_out = replay_screens_load
                      ),
            char_mask = 4
    ...
    sdl_repl_array_me_7dl_day1 = [
        sdl_repl_Label(
            "Автобус",
            sdl_Replay("alt_day1_me_7dl_bus_start", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "“Знакомство” с лагерем",
            sdl_Replay("alt_day1_me_7dl_meeting", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Первое воспоминание. 1988",
            sdl_Replay("alt_day1_me_7dl_memory1", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Роковая встреча",
            sdl_Replay("alt_day1_me_7dl_lena", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Ужин",
            sdl_Replay("alt_day1_me_7dl_supper", {"alt_replay_on" : "True"}, func_in = sunset_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Вечерние посиделки",
            sdl_Replay("alt_day1_me_7dl_music_club", {"alt_replay_on" : "True"}, func_in = sunset_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Второе воспоминание. 1988",
            sdl_Replay(
                        "alt_day1_me_7dl_memory2", {"alt_replay_on" : "True"},
                        music = music_7dl["take_my_hand"],
                        func_in = sunset_interface_on, func_out = replay_screens_load
                      )
        ),
        sdl_repl_Label(
            "Отбой",
            sdl_Replay("alt_day1_me_7dl_sleep", {"alt_replay_on" : "True"}, func_in = night_interface_on, func_out = replay_screens_load),
        )
    ]

    sdl_repl_array_me_7dl_day2 = [
        sdl_repl_Label(
            "Утро",
            sdl_Replay("alt_day2_me_7dl_begin", {"alt_replay_on" : "True"}, func_in = sunset_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Первое воспоминание. 1987",
            sdl_Replay("alt_day2_me_7dl_memory1", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Утро. Продолжение",
            sdl_Replay("alt_day2_me_7dl_begin_continue", {"alt_replay_on" : "True"}, func_in = sunset_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Завтрак",
            sdl_Replay("alt_day2_me_7dl_breakfast", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Обход лагеря",
            sdl_Replay("alt_day2_me_7dl_bypass", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load, music = music_list["take_me_beautifully"]),
        ),
        sdl_repl_Label(
            "Второе воспоминание. 1987",
            sdl_Replay("alt_day2_me_7dl_memory2", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Продолжение обхода",
            sdl_Replay("alt_day2_me_7dl_bypass_continue", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Обед",
            sdl_Replay("alt_day2_me_7dl_dinner", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Тихий час",
            sdl_Replay("alt_day2_me_7dl_silent_hour", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Полдник",
            sdl_Replay("alt_day2_me_7dl_lunch", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Пляжный эпизод",
            sdl_Replay("alt_day2_me_7dl_beach", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Ужин",
            sdl_Replay("alt_day2_me_7dl_supper", {"alt_replay_on" : "True"}, func_in = sunset_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Третье воспоминание. 1986",
            sdl_Replay("alt_day2_me_7dl_memory3", {"alt_replay_on" : "True"}, func_in = sunset_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Продолжение ужина",
            sdl_Replay("alt_day2_me_7dl_supper_continue", {"alt_replay_on" : "True"}, func_in = sunset_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Тяжёлый разговор",
            sdl_Replay("alt_day2_me_7dl_dv_talk", {"alt_replay_on" : "True"}, func_in = sunset_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Цена жизни",
            sdl_Replay("alt_day2_me_7dl_us_trace", {"alt_replay_on" : "True"}, func_in = night_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Обратно в лагерь",
            sdl_Replay("alt_day2_me_7dl_camp", {"alt_replay_on" : "True"}, func_in = night_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Отбой",
            sdl_Replay("alt_day2_me_7dl_sleep", {"alt_replay_on" : "True"}, func_in = night_interface_on, func_out = replay_screens_load),
        ),
    ]

    sdl_repl_array_me_7dl_day3 = [
        sdl_repl_Label(
            "Утро",
            sdl_Replay("alt_day3_me_7dl_begin", {"alt_replay_on" : "True"}, func_in = sunset_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Первое воспоминание. 1986",
            sdl_Replay("alt_day3_me_7dl_memory1", {"alt_replay_on" : "True"}, func_in = sunset_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Продолжение утра",
            sdl_Replay("alt_day3_me_7dl_begin_continue", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Завтрак",
            sdl_Replay("alt_day3_me_7dl_breakfast", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "День",
            sdl_Replay("alt_day3_me_7dl_day", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Обед",
            sdl_Replay("alt_day3_me_7dl_dinner", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Тихий час",
            sdl_Replay("alt_day3_me_7dl_silent_hour", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Вечер",
            sdl_Replay("alt_day3_me_7dl_evening", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Ужин",
            sdl_Replay("alt_day3_me_7dl_supper", {"alt_replay_on" : "True"}, func_in = sunset_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Дискотека",
            sdl_Replay("alt_day3_me_7dl_disco", {"alt_replay_on" : "True"}, func_in = sunset_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Второе воспоминание. 1987",
            sdl_Replay("alt_day3_me_7dl_memory2", {"alt_replay_on" : "True"}, func_in = sunset_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Продолжение дискотеки",
            sdl_Replay(
                        "alt_day3_me_7dl_disco_continue", {"alt_replay_on" : "True"},
                        vars = [
                                sdl_var_b_d3_me_7dl_dv_wish
                               ],
                        func_in = sunset_interface_on, func_out = replay_screens_load
            ),
        ),
        sdl_repl_Label(
            "Отбой",
            sdl_Replay(
                        "alt_day3_me_7dl_sleep", {"alt_replay_on" : "True"},
                        music = music_list["a_promise_from_distant_days_v2"],
                        func_in = night_interface_on,  func_out = replay_screens_load
                      )
        )
    ]

    sdl_repl_array_me_7dl_day4 = [
        sdl_repl_Label(
            "Утро",
            sdl_Replay(
                        "alt_day4_me_7dl_begin", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_b_d2_me_7dl_us_talk,
                                    sdl_var_b_d3_me_7dl_dv_wish
                                ],
                        func_in = sunset_interface_on, func_out = replay_screens_load
                      )
        ...
        sdl_repl_Label(
            "Завтрак",
            sdl_Replay("alt_day4_me_7dl_breakfast", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "День",
            sdl_Replay("alt_day4_me_7dl_day", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Обед",
            sdl_Replay(
                        "alt_day4_me_7dl_dinner", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_b_d3_me_7dl_dv_wish
                                ],
                        func_in = day_interface_on, func_out = replay_screens_load
        ...
        sdl_repl_Label(
            "Тихий час",
            sdl_Replay(
                        "alt_day4_me_7dl_silent_hour", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_b_d3_me_7dl_dv_wish
                                ],
                        func_in = day_interface_on, func_out = replay_screens_load
        ...
        sdl_repl_Label(
            "Полдник",
            sdl_Replay(
                        "alt_day4_me_7dl_lunch", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_b_d3_me_7dl_dv_wish
                                ],
                        func_in = day_interface_on, func_out = replay_screens_load
        ...
        sdl_repl_Label(
            "Концерт",
            sdl_Replay("alt_day4_me_7dl_concert", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Ужин",
            sdl_Replay("alt_day4_me_7dl_supper", {"alt_replay_on" : "True"}, func_in = sunset_interface_on, func_out = replay_screens_load),
        ),
        sdl_repl_Label(
            "Вечер",
            sdl_Replay(
                        "alt_day4_me_7dl_evening", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_b_d3_me_7dl_dv_wish,
                                    sdl_var_b_d4_me_7dl_mi_date
                                ],
                        func_in = sunset_interface_on, func_out = replay_screens_load
                      )
        ),
        sdl_repl_Label(
            "Цена",
            sdl_Replay(
                        "alt_day4_me_7dl_mi_treehouse", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_b_d2_me_7dl_us_talk,
                                    sdl_var_b_d3_me_7dl_dv_wish
                                ],
        ...
        sdl_repl_Label(
            "Обратно в лагерь",
            sdl_Replay(
                        "alt_day4_me_7dl_mz_checkers", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_b_d3_me_7dl_dv_wish
                                ],
                        func_in = sunset_interface_on, func_out = replay_screens_load
        ...
        sdl_repl_Label(
            "Отбой",
            sdl_Replay(
                        "alt_day4_me_7dl_sleep", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_b_d4_me_7dl_mi_date
                                ],
                        func_in = night_interface_on, func_out = replay_screens_load
    ...
    sdl_repl_array_me_7dl_day5 = [
        sdl_repl_Label(
            "Утро",
            sdl_Replay(
                "alt_day5_me_7dl_begin", {"alt_replay_on": "True"},
                vars=[
                sdl_var_b_d4_me_7dl_mi_date
                ],
                func_in=night_interface_on, func_out=replay_screens_load
        ...
        sdl_repl_Label(
            "Завтрак",
            sdl_Replay(
                "alt_day5_me_7dl_breakfast", {"alt_replay_on": "True"},
                vars=[
                sdl_var_b_d4_me_7dl_mi_date
                ],
                func_in=sunset_interface_on, func_out=replay_screens_load
        ...
        sdl_repl_Label(
            "Свечка",
            sdl_Replay(
                "alt_day5_me_7dl_cndl", {"alt_replay_on": "True"},
                vars=[
                sdl_var_b_d2_me_7dl_us_talk
                ],
                func_in=night_interface_on, func_out=replay_screens_load
        ...
        sdl_repl_Label(
            "Обед",
            sdl_Replay(
                "alt_day5_me_7dl_dinner", {"alt_replay_on": "True"},
                vars=[
                sdl_var_b_d4_me_7dl_mi_date
                ],
                func_in=sunset_interface_on, func_out=replay_screens_load
        ...
        sdl_repl_Label(
            "День",
            sdl_Replay(
                "alt_day5_me_7dl_day", {"alt_replay_on": "True"},
                func_in=day_interface_on, func_out=replay_screens_load
            )
        ),
        sdl_repl_Label(
            "Шпионские игры",
            sdl_Replay(
                "alt_day5_me_7dl_spy_games", {"alt_replay_on": "True"},
                vars=[
                sdl_var_b_d2_me_7dl_us_talk,
                sdl_var_b_d3_me_7dl_dv_wish
                ],
        ...
        sdl_repl_Label(
            "Ужин",
            sdl_Replay(
                "alt_day5_me_7dl_supper", {"alt_replay_on": "True"},
                vars=[
                sdl_var_b_d5_me_7dl_sl_buf
                ],
                func_in=sunset_interface_on, func_out=replay_screens_load
            )
        ),
        sdl_repl_Label(
            "Поход",
            sdl_Replay(
                "alt_day5_me_7dl_campfire", {"alt_replay_on": "True"},
                vars=[
                sdl_var_b_d5_me_7dl_sl_buf,
                sdl_var_b_d2_me_7dl_us_talk
                ],
        ...
        sdl_repl_Label(
            "Отбой",
            sdl_Replay(
                "alt_day5_me_7dl_sleep", {"alt_replay_on": "True"},
                vars=[
                sdl_var_b_d5_me_7dl_sl_buf
                ],
                func_in=night_interface_on, func_out=replay_screens_load
    ...
    sdl_repl_array_me_7dl_day6 = [
        sdl_repl_Label(
            "Утро",
            sdl_Replay(
                "alt_day6_me_7dl_begin", {"alt_replay_on": "True"},
                vars=[
                    sdl_var_b_d5_me_7dl_sl_buf
                ],
                func_in=sunset_interface_on, func_out=replay_screens_load
        ...
        sdl_repl_Label(
            "Завтрак",
            sdl_Replay(
                "alt_day6_me_7dl_breakfast", {"alt_replay_on": "True"},
                vars=[
                    sdl_var_b_d4_me_7dl_mi_date
                ],
                func_in=day_interface_on, func_out=replay_screens_load
        ...
        sdl_repl_Label(
            "День",
            sdl_Replay(
                "alt_day6_me_7dl_day", {"alt_replay_on": "True"},
                vars=[
                    sdl_var_b_d5_me_7dl_sl_buf,
                    sdl_var_b_d3_me_7dl_dv_wish
                ],
        ...
        sdl_repl_Label(
            "Обед",
            sdl_Replay(
                "alt_day6_me_7dl_dinner", {"alt_replay_on": "True"},
                vars=[
                    sdl_var_b_d2_me_7dl_us_talk
                ],
                func_in=day_interface_on, func_out=replay_screens_load
        ...
        sdl_repl_Label(
            "Тихий час",
            sdl_Replay(
                "alt_day6_me_7dl_silent_hour", {"alt_replay_on": "True"},
                vars=[
                    sdl_var_b_d4_me_7dl_mi_date,
                    sdl_var_b_d2_me_7dl_us_talk
                ],
        ...
        sdl_repl_Label(
            "Полдник",
            sdl_Replay(
                "alt_day6_me_7dl_lunch", {"alt_replay_on": "True"},
                func_in=day_interface_on, func_out=replay_screens_load
            )
        ),
        sdl_repl_Label(
            "Воспоминание. 1988",
            sdl_Replay(
                "alt_day6_me_7dl_concert", {"alt_replay_on": "True"},
                vars=[
                    sdl_var_b_d2_me_7dl_us_talk
                ],
                func_in=day_interface_on, func_out=replay_screens_load
        ...
        sdl_repl_Label(
            "Смирение",
            sdl_Replay(
                "alt_day6_me_7dl_un_talk", {"alt_replay_on": "True"},
                music = music_7dl["unforgotten"],
                func_in=day_interface_on, func_out=replay_screens_load
            )
        ),
        sdl_repl_Label(
            "Правда или вызов",
            sdl_Replay(
                "alt_day6_me_7dl_true_or_challenge", {"alt_replay_on": "True"},
                func_in=day_interface_on, func_out=replay_screens_load
            )
        ),
        sdl_repl_Label(
            "Ужин",
            sdl_Replay(
                "alt_day6_me_7dl_supper", {"alt_replay_on": "True"},
                vars=[
                    sdl_var_b_d6_me_7dl_un_glt,
                    sdl_var_b_d5_me_7dl_sl_buf
                ],
                func_in=sunset_interface_on, func_out=replay_screens_load
            )
        ...
        sdl_repl_Label(
            "Дискотека",
            sdl_Replay(
                "alt_day6_me_7dl_disco", {"alt_replay_on": "True"},
                vars=[
                    sdl_var_b_d6_me_7dl_un_glt,
                    sdl_var_b_d3_me_7dl_dv_wish
                ],
        ...
        sdl_repl_Label(
            "Маски сброшены",
            sdl_Replay(
                "alt_day6_me_7dl_mt_talk", {"alt_replay_on": "True"},
                music = music_7dl["sad_piano"],
                func_in=night_interface_on, func_out=replay_screens_load
            )
        ),
        sdl_repl_Label(
            "Король и Королева",
            sdl_Replay(
                "alt_day6_me_7dl_king_and_queen", {"alt_replay_on": "True"},
                music = music_7dl["fyrsta"],
                vars=[
                    sdl_var_b_d6_me_7dl_un_glt,
                    sdl_var_b_d2_me_7dl_us_talk,
                    sdl_var_b_d4_me_7dl_mi_date,
        ...
        sdl_repl_Label(
            "Отбой",
            sdl_Replay(
                "alt_day6_me_7dl_sleeptime", {"alt_replay_on": "True"},
                vars=[
                    sdl_var_b_d6_me_7dl_mt_tlk
                ],
                func_in=night_interface_on, func_out=replay_screens_load
            )
        ),
    ...
    sdl_repl_array_me_7dl_day7 = [
        sdl_repl_Label(
            "Утро",
            sdl_Replay(
                "alt_day7_me_7dl_begin", {"alt_replay_on": "True"},
                vars=[
                    sdl_var_b_d7_me_7dl_talks,
                    sdl_var_b_d6_me_7dl_mt_tlk
                ],
                func_in=sunset_interface_on, func_out=replay_screens_load
            )
        ...
        sdl_repl_Label(
            "Завтрак",
            sdl_Replay(
                "alt_day7_me_7dl_breakfast", {"alt_replay_on": "True"},
                vars=[
                    sdl_var_b_d5_me_7dl_sl_buf
                ],
                func_in=day_interface_on, func_out=replay_screens_load
        ...
        sdl_repl_Label(
            "День",
            sdl_Replay(
                "alt_day7_me_7dl_day", {"alt_replay_on": "True"},
                vars=[
                    sdl_var_b_d6_me_7dl_mt_tlk,
                    sdl_var_b_d7_me_7dl_talks
                ],
        ...
        sdl_repl_Label(
            ...
            sdl_Replay(
                "alt_day7_me_7dl_seeking_answers", {"alt_replay_on": "True"},
                func_in=day_interface_on, func_out=replay_screens_load
            )
        ),
        sdl_repl_Label(
            "Сборы",
            sdl_Replay(
                "alt_day7_me_7dl_packing", {"alt_replay_on": "True"},
                vars=[
                    sdl_var_b_d3_me_7dl_dv_wish
                ],
                func_in=day_interface_on, func_out=replay_screens_load
        ...
        sdl_repl_Label(
            "Визит к Виоле",
            sdl_Replay(
                "alt_day7_me_7dl_cs_visit", {"alt_replay_on": "True"},
                vars=[
                    sdl_var_e_d7_me_7dl_endings,
                    sdl_var_b_d2_me_7dl_us_talk
                ],
                func_in=day_interface_on, func_out=replay_screens_load
            )
        ...
        sdl_repl_Label(
            "Отъезд",
            sdl_Replay(
                "alt_day7_me_7dl_departure", {"alt_replay_on": "True"},
                vars=[
                    sdl_var_e_d7_me_7dl_endings,
                    sdl_var_b_d2_me_7dl_us_talk,
                    sdl_var_b_d5_me_7dl_sl_buf,
    ...
    ## Мику
    ### Мику-7дл
    sdl_repl_mi_7dl_start = sdl_repl_Day("Начать", sdl_repl_array_mi_7dl_start)
    ...
    ### Мику-Диджей
    sdl_repl_mi_djt_start = sdl_repl_Day("Начать", sdl_repl_array_mi_djt_start)
    ...
    ## Алиса
    ### Алиса-7дл
    sdl_repl_dv_7dl_start = sdl_repl_Day("Начать", sdl_repl_array_dv_7dl_start)
    ...
    ### Алиса-Диджей
    sdl_repl_dv_djt_start = sdl_repl_Day("Начать", sdl_repl_array_dv_djt_start)
    ...
    ## Славя
    ### Славя-7дл
    sdl_repl_sl_7dl_start = sdl_repl_Day("Начать", sdl_repl_array_sl_7dl_start)
    ...
    ### Славя-Классик
    sdl_repl_sl_clt_start = sdl_repl_Day("Начать", sdl_repl_array_sl_clt_start)
    ...
    ## Лена
    ### Лена-7дл
    sdl_repl_un_7dl_start = sdl_repl_Day("Начать", sdl_repl_array_un_7dl_start)
    ...
    ### Лена-Френдзона
    sdl_repl_un_fzd_start = sdl_repl_Day("Начать", sdl_repl_array_un_fzd_start, char_mask=2)
    ...
    ## Ольга
    ### Ольга-7дл
    sdl_repl_mt_7dl_start = sdl_repl_Day("Начать", sdl_repl_array_mt_7dl_start)
    ...
    ## Ульяна
    ### Ульяна-7дл
    sdl_repl_us_7dl_start = sdl_repl_Day("Начать", sdl_repl_array_us_7dl_start, char_mask=5)
    ...
    sdl_repl_us_7dl_days = [
        sdl_repl_us_7dl_start,
        sdl_repl_us_7dl_day6,
        sdl_repl_us_7dl_day7
    ]

    ## Одиночка
    sdl_repl_me_neu_start = sdl_repl_Day("Начать", sdl_repl_array_me_neu_start)
    ...
    sdl_repl_me_neu_day6_answ = sdl_repl_Day("День 6. Ответы", sdl_repl_array_me_neu_day6_answ)
    sdl_repl_me_neu_day7 = sdl_repl_Day("День 7", sdl_repl_array_me_neu_day7)
    sdl_repl_me_neu_days = [
        sdl_repl_me_neu_start,
        sdl_repl_me_neu_day4,
        sdl_repl_me_neu_day5,
        sdl_repl_me_neu_day6,
        sdl_repl_me_neu_day6_answ,
        sdl_repl_me_neu_day7
    ]

    ## Мажор
    sdl_repl_me_7dl_day1 = sdl_repl_Day("День 1", sdl_repl_array_me_7dl_day1)
    sdl_repl_me_7dl_day2 = sdl_repl_Day("День 2", sdl_repl_array_me_7dl_day2)
    sdl_repl_me_7dl_day3 = sdl_repl_Day("День 3", sdl_repl_array_me_7dl_day3)
    sdl_repl_me_7dl_day4 = sdl_repl_Day("День 4", sdl_repl_array_me_7dl_day4)
    sdl_repl_me_7dl_day5 = sdl_repl_Day("День 5", sdl_repl_array_me_7dl_day5)
    sdl_repl_me_7dl_day6 = sdl_repl_Day("День 6", sdl_repl_array_me_7dl_day6)
    sdl_repl_me_7dl_day7 = sdl_repl_Day("День 7", sdl_repl_array_me_7dl_day7)
    sdl_repl_me_7dl_days = [
        sdl_repl_me_7dl_day1,
        sdl_repl_me_7dl_day2,
        sdl_repl_me_7dl_day3,
        sdl_repl_me_7dl_day4,
        sdl_repl_me_7dl_day5,
        sdl_repl_me_7dl_day6,
        sdl_repl_me_7dl_day7
    ]

    # Руты | Разделы

    ## Коммон
    sdl_repl_common = sdl_repl_Section("Коммон-рут",     "#808080", None, sdl_repl_common_days)

    ## Мику
    sdl_repl_mi_7dl = sdl_repl_Section("Мику-7дл",       "#00DFFF", None, sdl_repl_mi_7dl_days)
    sdl_repl_mi_djt = sdl_repl_Section("Мику-Диджей",    "#00DFFF", None, sdl_repl_mi_djt_days)
    sdl_repl_mi_routes = [
        sdl_repl_mi_7dl,
        sdl_repl_mi_djt
    ]
    sdl_repl_mi = sdl_repl_Section("Мику", "#00DFFF", sdl_repl_mi_routes, None)

    ## Алиса
    sdl_repl_dv_7dl = sdl_repl_Section("Алиса-7дл",      "#FF7F00", None, sdl_repl_dv_7dl_days)
    sdl_repl_dv_djt = sdl_repl_Section("Алиса-Диджей",   "#FF7F00", None, sdl_repl_dv_djt_days)
    sdl_repl_dv_routes = [
        sdl_repl_dv_7dl,
        sdl_repl_dv_djt
    ]
    sdl_repl_dv = sdl_repl_Section("Алиса", "#FF7F00", sdl_repl_dv_routes, None)

    ## Славя
    sdl_repl_sl_7dl = sdl_repl_Section("Славя-7дл",      "#FFD400", None, sdl_repl_sl_7dl_days)
    sdl_repl_sl_clt = sdl_repl_Section("Славя-Классик",  "#FFD400", None, sdl_repl_sl_clt_days)
    sdl_repl_sl_routes = [
        sdl_repl_sl_7dl,
        sdl_repl_sl_clt
    ]
    sdl_repl_sl = sdl_repl_Section("Славя", "#FFD400", sdl_repl_sl_routes, None)

    ## Лена
    sdl_repl_un_7dl = sdl_repl_Section("Лена-7дл",       "#D456FF", None, sdl_repl_un_7dl_days)
    sdl_repl_un_fzd = sdl_repl_Section("Лена-Френдзона", "#D456FF", None, sdl_repl_un_fzd_days)
    sdl_repl_un_routes = [
        sdl_repl_un_7dl,
        sdl_repl_un_fzd
    ]
    sdl_repl_un = sdl_repl_Section("Лена", "#D456FF", sdl_repl_un_routes, None)

    ## Ольга
    sdl_repl_mt_7dl = sdl_repl_Section("Ольга-7дл",      "#00EA00", None, sdl_repl_mt_7dl_days)
    sdl_repl_mt_routes = [
        sdl_repl_mt_7dl
    ]
    sdl_repl_mt = sdl_repl_Section("Ольга", "#00EA00", sdl_repl_mt_routes, None)

    ## Ульяна
    sdl_repl_us_7dl = sdl_repl_Section("Ульяна-7дл",     "#FF0000", None, sdl_repl_us_7dl_days)
    sdl_repl_us_routes = [
        sdl_repl_us_7dl
    ]
    sdl_repl_us = sdl_repl_Section("Ульяна", "#FF0000", sdl_repl_us_routes, None)

    ## Семён/Одиночка
    sdl_repl_me_neu = sdl_repl_Section("Семён-Одиночка", "#808080", None, sdl_repl_me_neu_days)
    sdl_repl_me_7dl = sdl_repl_Section("Семён-7дл",      "#808080", None, sdl_repl_me_7dl_days)
    sdl_repl_me_routes = [
        sdl_repl_me_neu,
        sdl_repl_me_7dl
    ]
    sdl_repl_me = sdl_repl_Section("Семён", "#808080", sdl_repl_me_routes, None)
