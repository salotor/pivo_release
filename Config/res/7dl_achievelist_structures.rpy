init 9999 python:
    ...
    sdl_achv_array_mi_7dl = [
        ...
        sdl_achv_Achievement(    # Бэд-S
            ...
            7,
            sdl_Replay(
                        "alt_day7_mi_7dl_bad_star_ps", {"alt_replay_on" : "True"},
                        vars = [
    ...
    sdl_achv_array_dv_7dl = [
        sdl_achv_Achievement(    # Осколок памяти
            ...
            [
                ...
                sdl_achv_Prerequisite(
                    "sdl_achv_info_end",
                    {
                        sdl_achv_Achievement("acm_logo_un_7dl_shard", "un_7dl_shard", "sdl_achv_un_shard", None, None)
                    }
                )
            ],
        ...
        sdl_achv_Achievement(    # Meet Me There
            "acm_logo_dv_7dl_tran_un",
            "dv_7dl_tran_un",
            "sdl_achv_dv_tran",
            [],
            sdl_Replay(
                        "alt_day7_dv_7dl_tran_un", {"alt_replay_on" : "True"},
                        func_in = prolog_interface_on, func_out = replay_screens_load
                      ),
            "cry",
            1,
            None,
            Show("sdl_achv_sprite", Dissolve(0.5), "un", "cry", "modern")
        ),
        sdl_achv_Achievement(    # Бэд
            "acm_logo_dv_7dl_bad",
            "dv_7dl_bad",
        ...
        sdl_achv_Achievement(    # Осколок памяти
            ...
            [
                ...
                sdl_achv_Prerequisite(
                    "sdl_achv_info_end",
                    {
                        sdl_achv_Achievement("acm_logo_mi_7dl_shard", "mi_7dl_shard", "sdl_achv_mi_shard", None, None)
                    }
                )
            ],
    ...
    sdl_achv_array_un_7dl = [
        sdl_achv_Achievement(    # Осколок памяти
            ...
            [
                ...
                sdl_achv_Prerequisite(
                    "sdl_achv_info_end",
                    {
                        sdl_achv_Achievement("acm_logo_sl_7dl_shard", "sl_7dl_shard", "sdl_achv_sl_shard", None, None)
                    }
                )
            ],
        ...
        sdl_achv_Achievement(    # Реджект (Бывший транзит)
            "acm_logo_un_7dl_rej",
            "un_7dl_rej",
            "sdl_achv_un_rej",
            [],
            sdl_Replay("alt_day7_un_7dl_rej", {"alt_replay_on" : "True"}, func_in = night_interface_on, func_out = replay_screens_load),
            "sad"
        ),
        sdl_achv_Achievement(    # Бэд
            "acm_logo_un_7dl_bad",
        ...
        sdl_achv_Achievement(    # Осколок памяти
            ...
            [
                ...
                sdl_achv_Prerequisite(
                    "sdl_achv_info_end",
                    {
                        sdl_achv_Achievement("acm_logo_us_7dl_shard", "us_7dl_shard", "sdl_achv_us_shard", None, None)
                    }
                )
            ],
    ...
    sdl_achv_array_us_7dl = [
        sdl_achv_Achievement(    # Осколок памяти
            ...
            [
                ...
                sdl_achv_Prerequisite(
                    "sdl_achv_info_end",
                    {
                        sdl_achv_Achievement("acm_logo_dv_7dl_shard", "dv_7dl_shard", "sdl_achv_dv_shard", None, None)
                    }
                )
            ],
        ...
        sdl_achv_Achievement(    # ТруЪ
            ...
            5,
            None,
            Show("sdl_achv_sprite", Dissolve(0.5), "us", "grin", "grow_sport")
        ),
    ...
    ## Семён-Одиночка
    sdl_achv_array_me_neu = [
        sdl_achv_Achievement(    # Осколок памяти
            "acm_logo_me_neu_shard",
            "me_neu_shard",
            "sdl_achv_me_shard",
            [
                sdl_achv_Prerequisite(
                ...
                sdl_achv_Prerequisite(
                    "sdl_achv_info_end",
                    {
                        sdl_achv_Achievement("acm_logo_mt_7dl_shard", "mt_7dl_shard", "sdl_achv_mt_shard", None, None)
                    }
                )
            ],
            sdl_Replay("alt_day7_me_neu_shard", {"alt_replay_on" : "True"}, func_in = prolog_interface_on, func_out = replay_screens_load),
            "normal"
        ),
        sdl_achv_Achievement(    # Истинная Герка
            "acm_logo_me_neu_herc_true",
            "me_neu_herc_true",
            "sdl_achv_me_herc_true",
            [
                sdl_achv_Prerequisite(
                    "sdl_achv_info_puz",
                    None,
            ...
            sdl_Replay("alt_day6_me_neu_exc_answ_h", {"alt_replay_on" : "True"}, func_in = prolog_interface_on, func_out = replay_screens_load),
            "pi_smile",
            char_mask = 2
        ),
        sdl_achv_Achievement(    # Истинная Локи
            "acm_logo_me_neu_loki_true",
            "me_neu_loki_true",
            "sdl_achv_me_loki_true",
            [
                sdl_achv_Prerequisite(
                    "sdl_achv_info_puz",
                    None,
            ...
            sdl_Replay("alt_day6_me_neu_exc_answ_l", {"alt_replay_on" : "True"}, func_in = prolog_interface_on, func_out = replay_screens_load),
            "pi_smile",
            char_mask = 4
        ),
        sdl_achv_Achievement(    # Истинная Дрища
            "acm_logo_me_neu_dr_true",
            "me_neu_dr_true",
            "sdl_achv_me_dr_true",
            [
                sdl_achv_Prerequisite(
            ...
            sdl_Replay("alt_day6_me_neu_exc_answ_d", {"alt_replay_on" : "True"}, func_in = prolog_interface_on, func_out = replay_screens_load),
            "pi_smile",
            char_mask = 1
        ),
    ...
    # Семён-7дл
    sdl_achv_array_me_7dl = [
        sdl_achv_Achievement(    # Тру Мажора
            "acm_logo_me_7dl_true",
            "me_7dl_true",
            "sdl_achv_me_true",
            [],
            sdl_Replay("alt_day7_me_7dl_true", {"alt_replay_on" : "True"}, func_in = prolog_interface_on, func_out = replay_screens_load),
            "sad_smile"
        ),
        sdl_achv_Achievement(    # Гуд Мажора
            "acm_logo_me_7dl_good",
            "me_7dl_good",
            "sdl_achv_me_good",
            [],
            sdl_Replay("alt_day7_me_7dl_good",
                            {"alt_replay_on" : "True"},
                            music = music_7dl["abbys"],
                            func_in = prolog_interface_on,
                            func_out = replay_screens_load
                       ),
            "smile",
            7,
            sdl_Replay("alt_day7_me_7dl_good_ps", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load)
        ),
        sdl_achv_Achievement(    # Нейтрал Мажора
            "acm_logo_me_7dl_neutral",
            "me_7dl_neutral",
            "sdl_achv_me_neu",
            [],
            sdl_Replay("alt_day7_me_7dl_neutral", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load),
            "think",
            7,
            sdl_Replay("alt_day7_me_7dl_neutral_ps", {"alt_replay_on" : "True"}, func_in = day_interface_on, func_out = replay_screens_load)
        ),
    ]
    ...
    sdl_achv_array_va_smt = [
        ...
        sdl_achv_Achievement(    # Ламповость
            ...
            [],
            sdl_Replay(
                        "alt_achv_catapult", {"alt_replay_on" : "True"},
                        vars = [
                                    sdl_var_e_d0_catapult
                                ],
        ...
        sdl_achv_Achievement(    # дневник Ольги
            "acm_logo_va_diary",
            "alt_diary",
            "sdl_achv_va_diary",
            [],
            sdl_Replay("alt_day0_mt_7dl_diary", {"alt_replay_on" : "True"}, func_in = sunset_interface_on, func_out = replay_screens_load)
        )
    ]
    ...
    ## Семён
    sdl_achv_route_me_7dl = sdl_achv_Route("sdl_achv_me_7dl", "sdl_achv_7dl_route", "sdl_achv_me_7dl_active", "sdl_achv_me_7dl_inactive", sdl_achv_array_me_7dl, "am",  "pioneer")
    sdl_achv_route_me_neu = sdl_achv_Route("sdl_achv_me_neu", "sdl_achv_xxx_route", "sdl_achv_me_ow_active",  "sdl_achv_me_ow_inactive",  sdl_achv_array_me_neu, "am",  "pioneer")
    ## Разное
    ...
    sdl_achv_me_routes = [
        sdl_achv_route_me_7dl,
        sdl_achv_route_me_neu
    ]
    sdl_achv_va_routes = [
