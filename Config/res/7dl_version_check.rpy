...
init python:
    ...
    vars_050_saved = False
    vars_051_saved = False
    vars_052_saved = False
    vars_053_saved = False
    ...
    # читаем 'save_name' и ищем в строке "7ДЛ" - думаю, этого для идентификации мода достаточно
        if save_name.find(u'7ДЛ') != -1: # Если нашли вхождение '7ДЛ' в имени сохранения игры
            ...
            if (alt_save_release_no in alt_compatible_release_no[:10]) and (not vars_0402_saved):
                ...
                try:
                    if alt_day2_loki_minijack:
                        gl['alt_day2_minijack'] = True
                except Exception:
                    pass
                try:
                    if alt_day2_dv_bet_approve:
                        gl['alt_day2_dv_ultim'] = 1
                except Exception:
                    pass
                try:
                    if alt_day2_dv_harass:
                        gl['alt_day2_dv_ultim'] = 2
                except Exception:
                    pass
                try:
                    if alt_day2_slot_us_cake:
                        gl['alt_day2_us_cake'] = 1
                except Exception:
                    pass
                try:
                    if alt_day2_sup == 1:
                ...
                try:
                    if alt_day2_olga_help:
                        gl['alt_day2_mt_help'] = True
                except Exception:
                    pass
                try:
                    if alt_day3_us_shenan:
                        gl['alt_day2_us_shenan'] = True
                except Exception:
                    pass
                try:
                    if alt_day2_mi_rejected:
                        gl['alt_day2_mi_date'] = 2
                except Exception:
                    pass
                try:
                    if alt_day2_mi_hyst:
                        gl['alt_day2_mi_date'] = 3
                except Exception:
                    pass
                try:
                ...
                try:
                    if alt_day3_technoquest_st1:
                        gl['alt_day3_technoquest1'] = 1
                except Exception:
                    pass
                try:
                    if alt_day3_technoquest_st2:
                        gl['alt_day3_technoquest1'] = 2
                except Exception:
                    pass
                try:
                    if alt_day3_technoquest_st3_help:
                        gl['alt_day3_technoquest2'] = True
                except Exception:
                    pass
                try:
                    if alt_day3_dv_rep:
                ...
                try:
                    if alt_day3_dv2_event:
                        gl['alt_day3_dv_guitar'] = 2
                except Exception:
                    pass
                try:
                    if alt_day3_dv_guitar_lesson:
                        gl['alt_day3_dv_guitar'] = 3
                except Exception:
                    pass
                try:
                    if alt_day3_un_fz_dinner:
                        gl['counter_un_fz_un_route'] = 2
                except Exception:
                    pass
                try:
                    if alt_day3_un_fz_evening:
                        gl['counter_un_fz_un_route'] = 4
                except Exception:
                    pass
                try:
                ...
                try:
                    if alt_day3_dancing == 0:
                        gl['alt_day3_dancing1'] = 'me_1'
                except Exception:
                    pass
                try:
                    if alt_day3_dancing == 1:
                        gl['alt_day3_dancing1'] = 'un_1'
                except Exception:
                    pass
                try:
                    if alt_day3_dancing == 2:
                        gl['alt_day3_dancing1'] = 'sl_1'
                except Exception:
                    pass
                try:
                    if alt_day3_dancing == 3:
                        gl['alt_day3_dancing1'] = 'dv_1'
                except Exception:
                    pass
                try:
                    if alt_day3_dancing == 4:
                        gl['alt_day3_dancing1'] = 'mi_1'
                except Exception:
                    pass
                try:
                    if alt_day3_dancing == 132:
                        gl['alt_day3_dancing1'] = 'un_fz'
                except Exception:
                    pass
                try:
                    if alt_day3_dancing == 5:
                        gl['alt_day3_dancing2'] = 'me_2'
                except Exception:
                    pass
                try:
                    if alt_day3_dancing == 10:
                        gl['alt_day3_dancing2'] = 'un_2'
                except Exception:
                    pass
                try:
                    if alt_day3_dancing == 11:
                        gl['alt_day3_dancing2'] = 'un_12'
                except Exception:
                    pass
                try:
                    if alt_day3_dancing == 12:
                        gl['alt_day3_dancing2'] = 'un_0'
                except Exception:
                    pass
                try:
                    if alt_day3_dancing == 20:
                        gl['alt_day3_dancing2'] = 'sl_2'
                except Exception:
                    pass
                try:
                    if alt_day3_dancing == 21:
                        gl['alt_day3_dancing2'] = 'sl_12'
                except Exception:
                    pass
                try:
                    if alt_day3_dancing == 30:
                        gl['alt_day3_dancing2'] = 'dv_2'
                except Exception:
                    pass
                try:
                    if alt_day3_dancing == 31:
                        gl['alt_day3_dancing2'] = 'dv_12'
                except Exception:
                    pass
                try:
                    if alt_day3_dancing == 32:
                        gl['alt_day3_dancing2'] = 'dv_0'
                except Exception:
                    pass
                try:
                    if alt_day3_dancing == 40:
                        gl['alt_day3_dancing2'] = 'mi_2'
                except Exception:
                    pass
                try:
                    if alt_day3_dancing == 41:
                        gl['alt_day3_dancing2'] = 'mi_12'
                except Exception:
                    pass
                try:
                    if alt_day3_mi_donor:
                        gl['alt_day3_mi_7dl_donor'] = 1
                except Exception:
                    pass
                try:
                    if alt_day4_mi_7dl_donor:
                        gl['alt_day3_mi_7dl_donor'] = 2
                except Exception:
                    pass
                try:
                    if alt_day5_mi_dj_musclub_visited:
                        gl['list_mi_search_7dl'].append('musclub')
                except Exception:
                    pass
                try:
                    if alt_day5_mi_dj_entrance_visited:
                        gl['list_mi_search_7dl'].append('entrance')
                except Exception:
                    pass
                try:
                    if alt_day5_mi_dj_estrade_visited:
                        gl['list_mi_search_7dl'].append('estrade')
                except Exception:
                    pass
                try:
                    if alt_day5_mi_dj_home_visited:
                        gl['list_mi_search_7dl'].append('home')
                except Exception:
                    pass
                try:
                    if alt_day5_mi_dj_favorite_song:
                        gl['alt_day5_mi_dj_apology'] = 1
                except Exception:
                    pass
                try:
                    if alt_day5_mi_dj_cut:
                        gl['alt_day5_mi_dj_apology'] = 2
                except Exception:
                    pass
                try:
                    if alt_day5_mi_dj_forgive:
                        gl['alt_day5_mi_dj_apology'] = 3
                except Exception:
                    pass
                try:
                    if alt_day5_mi_dj_hentai:
                        gl['alt_day5_mi_dj_hentai_done'] = True
                except Exception:
                    pass
                try:
                    if alt_day6_mi_dj_letmestay:
                        gl['alt_day6_mi_dj_catapult'] = 1
                except Exception:
                    pass
                try:
                    if alt_day6_mi_dj_letmeout:
                        gl['alt_day6_mi_dj_catapult'] = 2
                except Exception:
                    pass
                try:
                    if alt_day6_mi_dj_sl_feed:
                        gl['alt_day6_mi_dj_feed'] = 'sl'
                except Exception:
                    pass
                try:
                    if not alt_day6_mi_dj_un_evil:
                        gl['alt_day6_mi_dj_feed'] = 'un'
                except Exception:
                    pass
                try:
                    if alt_day4_dv_7dl_hentai:
                        gl['alt_day4_dv_7dl_hentai_done'] = True
                except Exception:
                    pass
                try:
                    if alt_day4_dv_7dl_mt_drugs:
                        gl['alt_day4_dv_7dl_medication'] = 1
                except Exception:
                    pass
                try:
                    if alt_day4_dv_7dl_aidpost:
                        gl['alt_day4_dv_7dl_medication'] = 2
                except Exception:
                    pass
                try:
                    if alt_day4_dv_7dl_vodka:
                        gl['alt_day4_dv_7dl_vodka'] = 1
                except Exception:
                    pass
                try:
                    if alt_day4_dv_7dl_drank_vodka:
                        gl['alt_day4_dv_7dl_vodka'] = 2
                except Exception:
                    pass
                try:
                    if alt_day6_dv_7dl_sl_route:
                        gl['alt_day6_dv_7dl_route'] = 'sl'
                except Exception:
                    pass
                try:
                    if alt_day6_dv_7dl_mi_route:
                        gl['alt_day6_dv_7dl_route'] = 'un'
                except Exception:
                    pass
                try:
                    if alt_day6_dv_7dl_dance == 1:
                        gl['alt_day6_dv_7dl_dance'] = 'un'
                except Exception:
                    pass
                try:
                    if alt_day6_dv_7dl_dance == 22:
                        gl['alt_day6_dv_7dl_dance'] = 'sl'
                except Exception:
                    pass
                try:
                    if alt_day7_dv_7dl_check == 0:
                        gl['alt_day7_dv_7dl_check'] = 'dv_0'
                except Exception:
                    pass
                try:
                    if alt_day7_dv_7dl_check == 2:
                        gl['alt_day7_dv_7dl_check'] = 'dv_1'
                except Exception:
                    pass
                try:
                    if alt_day7_dv_7dl_check == 1:
                        gl['alt_day7_dv_7dl_check'] = 'dv_2'
                except Exception:
                    pass
                try:
                    if alt_day7_dv_7dl_check == 4:
                        gl['alt_day7_dv_7dl_check'] = 'un'
                except Exception:
                    pass
                try:
                    if alt_day7_dv_7dl_check == 22:
                        gl['alt_day7_dv_7dl_check'] = 'sl'
                except Exception:
                    pass
                try:
                    if alt_day7_dv_7dl_check == 5:
                        gl['alt_day7_dv_7dl_check'] = 'mt'
                except Exception:
                    pass
                try:
                    if alt_day4_sl_lf_solo == 0:
                        gl['alt_day4_sl_cl_lf_solo'] = 0
                except Exception:
                    pass
                try:
                    if alt_day4_sl_lf_solo == 1:
                        gl['alt_day4_sl_cl_lf_solo'] = 2
                except Exception:
                    pass
                try:
                    if alt_day4_sl_lf_solo == 2:
                        gl['alt_day4_sl_cl_lf_solo'] = 1
                except Exception:
                    pass
                try:
                    if alt_day4_sl_lf_solo == 3:
                        gl['alt_day4_sl_cl_lf_solo'] = 3
                except Exception:
                    pass
                try:
                    if alt_day4_sl_un_rej:
                        gl['alt_day4_sl_cl_un_rej'] = True
                except Exception:
                    pass
                try:
                    if alt_day4_sl_tut_iz:
                        gl['alt_day4_sl_cl_tut_iz'] = True
                except Exception:
                    pass
                try:
                    if alt_day4_sl_tut_lf:
                        gl['alt_day4_sl_cl_tut_lf'] = True
                except Exception:
                    pass
                try:
                    if alt_day6_sl_shirt:
                        gl['alt_day6_sl_cl_shirt'] = True
                except Exception:
                    pass
                try:
                    if alt_day6_sl_int:
                        gl['alt_day6_sl_cl_int'] = True
                except Exception:
                    pass
                try:
                    if alt_day5_sl_extra_house:
                        gl['alt_day5_sl_cl_hentai_done'] = True
                except Exception:
                    pass
                try:
                    if alt_day6_sl_repel:
                        gl['alt_day6_sl_cl_hentai_done'] = True
                except Exception:
                    pass
                try:
                    if alt_day6_sl_arc == 0:
                        gl['alt_day6_sl_cl_arc'] = 'pi'
                except Exception:
                    pass
                try:
                    if alt_day6_sl_arc == 1:
                        gl['alt_day6_sl_cl_arc'] = 'sh'
                except Exception:
                    pass
                try:
                    if alt_day4_un_7dl_dv_calm:
                        gl['alt_day4_un_7dl_calm'] = 'dv'
                except Exception:
                    pass
                try:
                    if alt_day4_un_7dl_un_calm:
                        gl['alt_day4_un_7dl_calm'] = 'un'
                except Exception:
                    pass
                try:
                    if alt_day5_un_7dl_sl_un_washing:
                        gl['alt_day5_un_7dl_washing'] = 'sl_un'
                except Exception:
                    pass
                try:
                    if alt_day5_un_7dl_solo_washing:
                        gl['alt_day5_un_7dl_washing'] = 'me'
                except Exception:
                    pass
                try:
                    if alt_day4_fz_un_letter:
                        gl['alt_day4_un_fz_letter'] = True
                except Exception:
                    pass
                try:
                    if alt_day4_fz_sh == 1:
                        gl['alt_day4_un_fz_companion'] = 'un'
                except Exception:
                    pass
                try:
                    if alt_day4_fz_sh == 2:
                        gl['alt_day4_un_fz_companion'] = 'sl'
                except Exception:
                    pass
                try:
                    if alt_day4_fz_sh == 3:
                        gl['alt_day4_un_fz_companion'] = 'dv'
                except Exception:
                    pass
                try:
                    if alt_day4_fz_sh == 4:
                        gl['alt_day4_un_fz_companion'] = 'el'
                except Exception:
                    pass
                try:
                    if alt_day4_neu_transit == 0:
                        gl['alt_day4_me_neu_transit'] = ''
                except Exception:
                    pass
                try:
                    if alt_day4_neu_transit == 1:
                        gl['alt_day4_me_neu_transit'] = 'un_7dl'
                except Exception:
                    pass
                try:
                    if alt_day4_neu_transit == 11:
                        gl['alt_day4_me_neu_transit'] = 'un_cl'
                except Exception:
                    pass
                try:
                    if alt_day4_neu_transit == 2:
                        gl['alt_day4_me_neu_transit'] = 'sl_cl'
                except Exception:
                    pass
                try:
                    if alt_day4_neu_transit == 5:
                        gl['alt_day4_me_neu_date'] = 'us'
                except Exception:
                    pass
                try:
                ...
                try:
                    if alt_day4_neu_date == 3:
                        gl['alt_day4_me_neu_date'] = 'dv'
                except Exception:
                    pass
                try:
                    if alt_day4_neu_date == 4:
                        gl['alt_day4_me_neu_date'] = 'mi'
                except Exception:
                    pass
                try:
                    if alt_day4_neu_mt_volley:
                        gl['alt_day4_me_neu_volley'] = True
                except Exception:
                    pass
                try:
                    if alt_day4_neu_mt_songs:
                        gl['alt_day4_me_neu_mi_songs'] = True
                except Exception:
                    pass
                try:
                    if alt_day4_neu_mt_diary:
                        gl['alt_day4_me_neu_mt_diary'] = True
                except Exception:
                    pass
                try:
                    if alt_day4_neu_mt_volonteer:
                        gl['alt_day4_me_neu_mt_volonteer'] = True
                except Exception:
                    pass
                try:
                    if mt_pt:
                        gl['counter_mt_7dl'] = mt_pt
                except Exception:
                    pass
                try:
                    if us_pt:
                        gl['counter_us_7dl'] = us_pt
                except Exception:
                    pass
                try:
                    if alt_day4_neu_us_pixies:
                        gl['counter_us_px'] = alt_day4_neu_us_pixies
                except Exception:
                    pass
                try:
                    if alt_day5_neu_candle:
                        gl['alt_day5_me_neu_candle'] = alt_day5_neu_candle
                except Exception:
                    pass
                try:
                    if alt_day5_neu_mt_voyeur:
                        gl['alt_day5_me_neu_mt_voyeur'] = alt_day5_neu_mt_voyeur
                except Exception:
                    pass
                try:
                    if alt_day5_neu_us_stores:
                        gl['alt_day5_me_neu_us_stores'] = True
                except Exception:
                    pass
                try:
                    if alt_day5_neu_sl_voyeur:
                        gl['alt_day5_me_neu_sl_voyeur'] = True
                except Exception:
                    pass
                try:
                    if alt_day5_neu_potato:
                        gl['alt_day5_me_neu_potato'] = True
                except Exception:
                    pass
                try:
                    if alt_day5_neu_mt_diary:
                        gl['alt_day5_me_neu_mt_diary'] = True
                except Exception:
                    pass
                try:
                    if alt_day5_neu_us_potato:
                        gl['alt_day5_me_neu_us_potato'] = True
                except Exception:
                    pass
                try:
                    if alt_day5_mt_7dl_hentai:
                        gl['alt_day5_me_neu_mt_hentai'] = True
                except Exception:
                    pass
                try:
                    if alt_day6_us_7dl_tr:
                        gl['alt_day6_us_7dl_help'] = True
                except Exception:
                    pass
                try:
                    if ('men_clubs' in list_voyage_7dl):
                        gl['list_voyage_7dl'].append('cyber')
                except Exception:
                    pass
                try:
                    if routetag == "us7dl_good":
                        gl['routetag'] = "us_px_good"
                except Exception:
                    pass
                try:
                    if routetag == "us7dl_good_surp":
                        gl['routetag'] = "us_px_good_surp"
                except Exception:
                    pass
                try:
                ...
                try:
                    if routetag == "us7dl_bad_laugh":
                        gl['routetag'] = "us_7dl_good"
                except Exception:
                    pass
                try:
                    if routetag == "us7dl_bad_sad":
                        gl['routetag'] = "us_7dl_bad"
                except Exception:
                    pass
                # Новый турнир
                try:
                    if alt_pe == 1:
                        gl['alt_my_rival_1_tour.take'] = 'un'
                except Exception:
                    pass

                try:
                    if alt_day2_hf2 == 1:
                        gl['alt_my_rival_semifinal.take'] = 'un'
                except Exception:
                    pass

                try:
                    if alt_day2_hf2 == 5:
                        gl['alt_my_rival_semifinal.take'] = 'us'
                except Exception:
                    pass

                try:
                    if alt_day2_round3 == 1:
                        gl['alt_day2_gamblers_result']['me'] = 21
                except Exception:
                    pass

                try:
                    if alt_day2_round3 == 2:
                        gl['alt_day2_gamblers_result']['me'] = 22
                except Exception:
                    pass

                try:
                    if alt_day2_f1 == 1 and alt_day2_round3 == 2:
                        gl['alt_day2_gamblers_result']['un'] = 21
                    elif alt_day2_f1 == 1 and alt_day2_round3 == 1:
                        gl['alt_day2_gamblers_result']['un'] = 22
                except Exception:
                    pass

                try:
                    if alt_day2_f1 == 4 and alt_day2_round3 == 2:
                        gl['alt_day2_gamblers_result']['mi'] = 21
                    elif alt_day2_f1 == 4 and alt_day2_round3 == 1:
                        gl['alt_day2_gamblers_result']['mi'] = 22
                except Exception:
                    pass

                try:
                    if alt_day2_f1 == 5 and alt_day2_round3 == 2:
                        gl['alt_day2_gamblers_result']['us'] = 21
                    elif alt_day2_f1 == 5 and alt_day2_round3 == 1:
                        gl['alt_day2_gamblers_result']['us'] = 22
                except Exception:
                    pass

                try:
                    if alt_day2_round1 == 1:
                        gl['alt_day2_gamblers_result']['me'] = 1
                except Exception:
                    pass

                try:
                    if alt_day2_round2 == 1:
                        gl['alt_day2_gamblers_result']['me'] = 11
                except Exception:
                    pass
            ...
            if (alt_save_release_no == "0.43") and (not vars_043_saved):
                gl['vars_043_saved'] = True
                try:
                    if alt_day3_un_fz_dv_fake_date:
                        gl['counter_un_fz_dv_fake_date'] = alt_day3_un_fz_dv_fake_date
                        gl['alt_day3_un_fz_work'] = 'dv'
                except Exception:
                    pass
                try:
                    if alt_day4_un_fz_mt_transit:
                        gl['counter_un_fz_mt_transit'] = alt_day4_un_fz_mt_transit
                except Exception:
                    pass
                try:
                    if counter_old_road:
                        gl['counter_un_fz_old_road'] = counter_old_road
                except Exception:
                    pass
                try:
                    if counter_un_fz:
                        gl['counter_un_fz_un_route'] = counter_un_fz
                except Exception:
                    pass
                try:
                    if alt_day3_un_fz_un_work:
                        gl['alt_day3_un_fz_work'] = 'un'
                except Exception:
                    pass
                try:
                    if alt_day3_un_fz_sl_work:
                        gl['alt_day3_un_fz_work'] = 'sl'
                except Exception:
                    pass
                try:
                    if alt_day4_un_fz_un_help:
                        gl['alt_day4_un_fz_morning_event'] = 'un'
                except Exception:
                    pass
                try:
                    if alt_day4_un_fz_mt_transit:
                        gl['alt_day4_un_fz_morning_event'] = 'mt'
                except Exception:
                    pass
                try:
                    if alt_day4_un_fz_dv_escape:
                        gl['alt_day4_un_fz_morning_event'] = 'dv'
                except Exception:
                    pass
                try:
                    if alt_day4_un_fz_un_evening_walk:
                        gl['alt_day4_un_fz_un_evening'] = 'walk'
                except Exception:
                    pass
                try:
                    if alt_day4_un_fz_un_evening_sleep:
                        gl['alt_day4_un_fz_un_evening'] = 'sleep'
                except Exception:
                    pass
                try:
            ...
            if (alt_save_release_no in alt_compatible_release_no[:19]) and (not vars_049_saved):
                gl['vars_049_saved'] = True
                try:
                    if alt_day4_sl_7dl_phone:
                        gl['alt_day6_sl_7dl_square'] = True
                except Exception:
                    pass
                try:
                    if alt_day6_us_px_sl_join:
                        gl['alt_day6_us_7dl_px_sl_join'] = True
                except Exception:
                    pass
                try:
                    if alt_day7_us_px_escaped:
                        gl['alt_day7_us_7dl_px_escaped'] = True
                except Exception:
                    pass
                try:
                    if counter_us_px:
                        gl['counter_us_7dl_px'] = counter_us_px
                except Exception:
                    pass
                try:
                    if dv_dj_morning:
                ...
                if routetag == "prologue":
                    ...
                    for i in ["День 4","День 5","День 6","День 7"]:
                        if i in save_name:
                            gl['routetag'] = "neu"
            if (alt_save_release_no in alt_compatible_release_no[:20]) and (not vars_050_saved):
                gl['vars_050_saved'] = True
                try:
                    if alt_day6_sl_cl_int == 5:
                        gl['alt_day6_sl_cl_int_end'] = 'rej'
                except Exception:
                    pass
                try:
                    if alt_day6_sl_cl_int == 4:
                        gl['alt_day6_sl_cl_int_end'] = 'true'
                except Exception:
                    pass
                try:
                    if alt_day6_sl_cl_int == 3:
                        gl['alt_day6_sl_cl_int_end'] = 'good'
                except Exception:
                    pass
                try:
                    if (not alt_day4_me_neu_escape) and ('nwsppr' not in list_clubs_7dl) and ('music' in list_clubs_7dl):
                        gl['alt_day4_me_neu_mi_club'] = True
                except Exception:
                    pass
                try:
                ...
                try:
                    ...
                    pass
            if (alt_save_release_no in alt_compatible_release_no[:21]) and (not vars_051_saved):
                gl['vars_051_saved'] = True
                try:
                    if alt_day6_me_neu_dance_invite not in ['dv','mi','sl','un','us'] and counter_mz_7dl != 3 and counter_mt_7dl < 5 and alt_day4_me_neu_us_debt and alt_day5_me_neu_clubs_cyber and alt_day6_me_neu_clubs_cyber:
                        gl['alt_day6_me_neu_cyberfire'] = True
                except Exception:
                    pass
            if (alt_save_release_no in alt_compatible_release_no[:22]) and (not vars_052_saved):
                gl['vars_052_saved'] = True
                try:
                    if alt_day6_dv_dj_secret or (not alt_day4_dv_dj_radio_scoff) or (alt_day5_dv_dj_map == "un"):
                        gl['secret_dv_dj'] = int(alt_day6_dv_dj_secret) + int(not alt_day4_dv_dj_radio_scoff) + int(alt_day5_dv_dj_map == "un")
                except Exception:
                    pass
                try:
                    if (alt_day5_me_neu_candle in (1, 2)) and (not alt_day5_me_neu_candle_escape) and (counter_me_neu_answers <= 1):
                        gl['alt_day5_me_neu_candle_stay'] = True
                except Exception:
                    pass
            if (alt_save_release_no in alt_compatible_release_no[:23]) and (not vars_053_saved):
                gl['vars_053_saved'] = True
                try:
                    if (alt_day5_me_neu_candle in (1, 2)) and (not alt_day5_me_neu_candle_escape) and (counter_me_neu_answers <= 1):
                        gl['alt_day5_me_neu_candle_stay'] = True
                except Exception:
            ...
            if (alt_save_release_no not in alt_compatible_release_no): # и если сохранение несовместимо
                # генерируем строку с номерами версий
                gl['alt_aicr_string'] = (u"ЗАГРУЖАЕМАЯ ВЕРСИЯ СОХРАНЕНИЯ (%s) НЕСОВМЕСТИМА С ЭТОЙ ВЕРСИЕЙ МОДА (%s)") % (alt_save_release_no, alt_release_no)
                gl['alt_save_release_no'] = alt_release_no
                renpy.show_screen("alt_incompatible_release") # и показываем экран предупреждения с выбором вариантов
            elif ( (alt_save_release_no in alt_compatible_release_no[:10]) # не помню, с чем связано
            or     ((alt_save_release_no in ["0.42", "0.43"]) and counter_un_cl) # выпил Лены-классик
            or     ((alt_save_release_no in alt_compatible_release_no[:19]) and ("us_px" in routetag)) # объединение Огоньков с Ульяной-7дл
            or     ((alt_save_release_no in alt_compatible_release_no[:20]) and alt_day6_sl_cl_int) # перепил инт-ветки Слави-классик
            or     ((alt_save_release_no in alt_compatible_release_no[:22]) and (("un7dl" in routetag) or (routetag == "un")) and ("День 7" in save_name)) # введение новой переменной alt_day7_un_7dl_rnm в конце 6-го дня Лены-7дл
                 ): # если сохранение частично совместимо
                gl['alt_aicr_string'] = (u"ВЫ ЗАГРУЖАЕТЕ СОХРАНЕНИЕ С УСТАРЕВШЕЙ (%s) ВЕРСИИ МОДА") % (alt_save_release_no) # генерируем строку с предупреждением
                gl['alt_save_release_no'] = alt_release_no
                renpy.show_screen("alt_load_warning") # и показываем экран с возможностью перейти на начало игрового дня
...
init 1: # Переименования персистентов
    ...
    if not persistent.not_first_start9_7dl:
        ...
        python:
            try:
                if persistent._seen_ever['alt_day6_me_neu_us_danсe']:
                    persistent._seen_ever['alt_day6_me_neu_us_dance'] = True
            except Exception:
                pass
        python:
            try:
                if persistent._seen_ever['alt_day6_me_neu_mz_danсe']:
                    persistent._seen_ever['alt_day6_me_neu_mz_dance'] = True
            except Exception:
                pass
        python:
            try:
                if persistent._seen_ever['alt_day6_me_neu_ka_danсe']:
                    persistent._seen_ever['alt_day6_me_neu_ka_dance'] = True
            except Exception:
                pass

    if not persistent.not_first_start10_7dl:
        $ persistent.not_first_start10_7dl = True
        if persistent.un_7dl_true_tran:
            $ persistent.un_7dl_rej2 = persistent.un_7dl_true_tran
            $ persistent.un_7dl_true_tran = False

    if not persistent.not_first_start11_7dl:
        $ persistent.not_first_start11_7dl = True
        python:
            try:
                if persistent._seen_ever['alt_day4_un_7dl_cinema']:
                    persistent._seen_ever['alt_day5_un_7dl_cinema'] = True
            except Exception:
                pass

    if not persistent.not_first_start12_7dl:
        $ persistent.not_first_start12_7dl = True
        python:
            try:
                if persistent._seen_ever['alt_day7_un_7dl_day']:
                    persistent._seen_ever['alt_day7_un_7dl_day_late'] = True
            except Exception:
                pass

    if not persistent.not_first_start13_7dl:
        $ persistent.not_first_start13_7dl = True
        if persistent.un_7dl_rej:
            $ persistent.un_7dl_rej = False
        if persistent.un_7dl_rej2:
            $ persistent.un_7dl_rej = persistent.un_7dl_rej2
            $ persistent.un_7dl_rej2 = False

    if not persistent.not_first_start14_7dl:
        $ persistent.not_first_start14_7dl = True
        if persistent.mi_7dl_club27:
            $ persistent.alt_club27 = persistent.mi_7dl_club27
            $ persistent.mi_7dl_club27 = False

    if not persistent.not_first_start15_7dl:
        $ persistent.not_first_start15_7dl = True
        python:
            try:
                if persistent._seen_images[('cg', 'day6_mt_crying_7dl')]:
                    persistent._seen_images[('cg', 'd6_mt_crying_7dl')] = True
            except Exception:
                pass
            try:
                if persistent._seen_images[('cg', 'd2_mt_undressed')]:
                    persistent._seen_images[('cg', 'd2_mt_undressed_7dl')] = True
            except Exception:
                pass
            try:
                if persistent._seen_images[('cg', 'd2_mt_undressed_2')]:
                    persistent._seen_images[('cg', 'd2_mt_undressed_2_7dl')] = True
            except Exception:
                pass
            try:
                if persistent._seen_images[('cg', 'd6_sl_hentai_2')]:
                    persistent._seen_images[('cg', 'd6_sl_hentai_2_7dl')] = True
            except Exception:
                pass
            try:
                if persistent._seen_images[('cg', 'd6_sl_swim')]:
                    persistent._seen_images[('cg', 'd6_sl_swim_7dl')] = True
            except Exception:
                pass
...
# кнопки выборов
        button: # начинаем заново
            xalign 0.5
            yalign 0.65
            action [Hide("alt_incompatible_release"), Jump("start_7dl")]
            background None
        ...
        button: # выходим в меню загрузки, ищем что-то другое
            xalign 0.5
            yalign 0.75
            action [Hide("alt_incompatible_release"), ShowMenu('load')]
            background None
...
# Продолжение игры номер сохранения не перепишет; так что окно проверки будет вываливаться каждый раз
        button:
            xalign 0.5
            yalign 0.85
            action [Hide("alt_incompatible_release"), Return()] # возвращаемся в игру
            background None
...
screen alt_load_warning:
    ...
    window:
        ...
        button: # выходим в меню загрузки, ищем что-то другое
            xalign 0.5
            yalign 0.75
            action [Hide("alt_load_warning"), ShowMenu('load')]
            background None
            text u"Загрузить другое сохранение":
                hover_size 50
                color aicr_colors[persistent.timeofday]
        ...
        button: # начинаем с начала дня
            ...
            if (alt_save_release_no in ["0.42", "0.43"]) and counter_un_cl:
                action [Hide("alt_load_warning"), Jump("alt_day3_un_cl_start")]
            elif routetag == "prologue":
                if "пролог" in save_name:
                    action [Hide("alt_load_warning"), Jump("start_7dl")]
                elif "День 1 — ОТКАТ" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day1_me_d3_start")]
                elif "День 2 — ОТКАТ" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day2_me_d3_start")]
                elif "День 1" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day1_start")]
                elif "День 2" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day2_start")]
                elif "День 3" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day3_start")]
                elif "День 4" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day4_me_neu_start")]
                elif "День 5" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day5_me_neu_start")]
                elif "День 6" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day6_me_neu_start")]
                elif "День 7" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day7_me_neu_start")]
            elif "dv7dl" in routetag:
                if "День 4" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day4_dv_7dl_start")]
                elif "День 5" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day5_dv_7dl_start")]
                elif "День 6" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day6_dv_7dl_start")]
                elif "День 7" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day7_dv_7dl_start")]
            elif routetag == "Noir":
                action [Hide("alt_load_warning"), Jump("alt_day4_no_start")]
            elif ("mi7" in routetag) and (alt_day3_dj == "mi"):
                if "День 4" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day4_mi_dj_start")]
                elif "День 5" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day5_mi_dj_start")]
                elif "День 6" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day6_mi_dj_start")]
                elif "День 7" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day7_mi_dj_start")]
            elif "mi7" in routetag:
                if "День 4" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day4_mi_7dl_start")]
                elif "День 5" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day5_mi_7dl_start")]
                elif "День 6" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day6_mi_7dl_start")]
                elif "День 7" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day7_mi_7dl_start")]
            elif "mt7dl" in routetag:
                if "День 6" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day6_mt_7dl_start")]
                elif "День 7" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day7_mt_7dl_start")]
            elif "sl7dl" in routetag:
                if "День 4" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day4_sl_7dl_start")]
                elif "День 5" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day5_sl_7dl_start")]
                elif "День 6" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day6_sl_7dl_start")]
                elif "День 7" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day7_sl_7dl_start")]
            elif "sl" in routetag:
                if "День 4" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day4_sl_cl_start")]
                elif "День 5" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day5_sl_cl_start")]
                elif "День 6" in save_name or ("День 7" in save_name and routetag == "sltrue"):
                    action [Hide("alt_load_warning"), Jump("alt_day6_sl_cl_start")]
                elif "День 7" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day7_sl_cl_start")]
            elif (alt_day2_date == 'un_fz') and (alt_day3_dancing1 == 'un_fz') and (routetag == "un7dl"):
                if "День 4" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day4_un_fz_start")]
                elif "День 5" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day5_un_fz_start")]
            elif ("un7dl" in routetag) or (routetag == "un"):
                if "День 4" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day4_un_7dl_start")]
                elif "День 5" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day5_un_7dl_start")]
                elif ("День 6" in save_name) or ("День 7" in save_name):
                    action [Hide("alt_load_warning"), Jump("alt_day6_un_7dl_start")]
            elif ("us_7dl" in routetag) or ("us_px" in routetag):
                if "День 6" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day6_us_7dl_start")]
                elif "День 7" in save_name:
                    action [Hide("alt_load_warning"), Jump("alt_day7_us_7dl_start")]
            else:
                action [Hide("alt_load_warning"), Jump("start_7dl")]
            background None
