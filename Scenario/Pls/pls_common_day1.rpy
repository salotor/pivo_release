label alt_day1_start:
    ...
    pause(1)
    $ alt_save_name(1, u"Первое знакомство")
    ...
    if (counter_sl_7dl != 1):
        if herc or loki:
            ...
            $ alt_save_name(1, u"Склад")
            call alt_day1_warehouse
            pause(1)
    $ alt_save_name(1, u"Вожатая")
    call alt_day1_mod_tan
    pause(1)
    $ alt_save_name(1, u"Электроник")
    call alt_day1_elektron
    pause(1)
    $ alt_save_name(1, u"Экскурсия")
    ...
    pause(1)
    if (counter_sl_7dl == 2):
        $ alt_save_name(1, u"Экскурсия. Вечер")
        call alt_day1_meeting2
    else:
        $ alt_save_name(1, u"Погоня")
        call alt_day1_chase
        pause(1)
        ...
        $ night_time()
        $ alt_save_name(1, u"Спасительница")
