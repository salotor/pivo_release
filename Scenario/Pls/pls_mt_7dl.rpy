label alt_day6_mt_7dl_start:
    ...
    $ sunset_time()
    $ alt_chapter(6, u"Ольга. 7ДЛ. Утро")
    call alt_day6_mt_7dl_begin
    pause(1)
    call alt_day6_mt_7dl_breakfast
    pause(1)
    $ alt_chapter(6, u"Ольга. 7ДЛ. О ненужных")
    ...
    if alt_day5_me_neu_mt_hentai:
        ...
        pause(1)
        $ alt_chapter(6, u"Ольга. 7ДЛ. Первые встречи")
        ...
        if alt_day4_me_neu_mt_diary and alt_day5_me_neu_mt_diary:
            pause(1)
            $ alt_chapter(6, u"Ольга. 7ДЛ. Дневник. 1989")
            call alt_day6_mt_7dl_diary3
    pause(1)
    $ persistent.sprite_time = "day"
    $ day_time()
    $ alt_chapter(6, u"Ольга. 7ДЛ. День")
    call alt_day6_mt_7dl_dinner
    pause(1)
    call alt_day6_mt_7dl_memory
    pause(1)
    $ alt_chapter(6, u"Ольга. 7ДЛ. Концерт")
    ...
    $ persistent.sprite_time = "sunset"
    $ sunset_time()
    $ alt_chapter(6, u"Ольга. 7ДЛ. Вечер")
    ...
    $ night_time()
    $ alt_chapter(6, u"Ольга. 7ДЛ. Воссоединение")
...
label alt_day7_mt_7dl_start:
    ...
    $ persistent.sprite_time = "sunset"
    $ sunset_time()
    $ alt_chapter(7, u"Ольга. 7ДЛ. Утро")
    ...
    pause(1)
    $ alt_chapter(7, u"Ольга. 7ДЛ. Прощание")
    ...
    if alt_day7_mt_7dl_pt == 1:
        $ persistent.sprite_time = "day"
        $ day_time()
        $ alt_chapter(7, u"Ольга. 7ДЛ. Выбор: прошлое")
        ...
        $ persistent.sprite_time = "day"
        $ day_time()
        $ alt_chapter(7, u"Ольга. 7ДЛ. Лик прошлого")
        call alt_day7_mt_7dl_shard
    else:
        $ persistent.sprite_time = "prolog"
        $ prolog_time()
        $ alt_chapter(7, u"Ольга. 7ДЛ. Выбор: будущее")
