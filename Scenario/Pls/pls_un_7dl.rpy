...
label alt_day6_un_7dl_start:
    ...
    if (herc and alt_day7_un_7dl_rnm >= 120 and karma >= 120) or (loki and alt_day7_un_7dl_rnm >= 100 and karma >= 110) or (dr and alt_day7_un_7dl_rnm >= 100 and karma >= 100) or (alt_day4_me_neu_transit == 'un_7dl' and ((herc and alt_day7_un_7dl_rnm >= 95 and karma >= 120) or (loki and alt_day7_un_7dl_rnm >= 80 and karma >= 110) or (dr and alt_day7_un_7dl_rnm >= 80 and karma >= 100))):
        $ alt_day6_un_7dl_good_ussr_check = True

    $ lp_un = alt_day7_un_7dl_rnm

    if alt_day6_un_7dl_good_ussr_check:
        $ routetag = "un7dlgoodsu"
    elif alt_day4_me_neu_transit == 'un_7dl':
        $ routetag = "un"
    elif alt_day7_un_7dl_rnm >= 75:
        $ routetag = "un7dlgoodrf"
    else:
        $ routetag = "un7dlbad"
...
label alt_day7_un_7dl_start:
    ...
    $ persistent.sprite_time = "day"
    $ day_time()
    call alt_day7_un_7dl_wakeup
    pause(1)
    $ alt_chapter(7, u"Лена. 7ДЛ. День")
    if dr and 'nwsppr' in list_clubs_7dl:
        call alt_day7_un_7dl_dr_nwsppr_day
    elif loki and (alt_day1_sl_keys_took in (1, 3)):
        call alt_day7_un_7dl_loki_keys_day
    else:
        call alt_day7_un_7dl_day_default
    pause(1)
    call alt_day7_un_7dl_packing
    pause(1)
    if routetag == "un7dlgoodsu":
