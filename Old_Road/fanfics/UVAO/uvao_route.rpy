...
label alt_day4_uvao_aidpost: #беседуем с Виолой
    ...
    play music sfx_7dl["eat_horn"] fadein 2
...
label alt_day4_uvao_breakfast:
    ...
    th "Где разжиться более или менее актуальной информацией о происходящем, не вызывая подозрений?{w} Правильно, в интернете. Чем заменить при отсутствии?{w} Телевидением и газетами."
...
#
    ...
    el "Виолетта мне сказала, что завтра его отпустит, наверное."
...
#    play sound sfx_angry_ulyana
    ...
    th "…"
    scene cg d4_uv_pioner_lib_hiding_7dl
...
# Утром были у Виолы и в прологе выбрали "Я пойду с тобой", можем поужинать вместе
        ...
        menu:
            "Подсесть к Виолетте":
                ...
                cs "Смысл тебя потрошить? Такой же человек, как и все. Ну, жил на пару-тройку десятков лет в будущем, подумаешь."
...
label alt_day5_uvao_tunnel:
    ...
    scene bg int_catacombs_door_light2_7dl with dissolve
...
label alt_day5_uvao_thinking:
    play music music_7dl["my_chrysalis_highwayman"] fadein 3
...
label alt_day5_uvao_true_back:
    ...
    play sound sfx_open_door_mines_metal
    scene bg int_catacombs_door_light2_7dl with fade
    $ night_time()
    $ persistent.sprite_time = "night"
    show uv normal at cright with dissolve
...
label alt_day5_uvao_mines_begin:
    ...
    $ renpy.music.play( (sfx_7dl["match_lights"], sfx_7dl["silence"]), 'sound', True)
...
label alt_day5_uvao_mines_sh:
    ...
    hide uv
    scene bg int_mines_halt_spotlight_7dl:
...
#    hide uv
    scene bg int_catacombs_entrance_light_7dl with fade
...
label alt_day5_parking_back:
    ...
    stop music fadeout 2
    stop ambience fadeout 3
    scene bg int_catacombs_entrance_light_7dl with dissolve
    with vpunch
    play ambience ambience_catacombs fadein 3
    $ night_time()
    $ persistent.sprite_time = "night"
    ...
    stop ambience fadeout 3
    scene bg ext_camp_entrance_sunset_7dl with dissolve2
    ...
    if alt_uvao_D5_hentai:
        ...
        "Не удержавшись, я провел рукой по пушистому, удивлённо поднятому хвосту."
    ...
    "Вспышка, Юля подскочила от неожиданности, а я скорее полез в телефон посмотреть снимок."
    play sound sfx_scary_sting
    scene cg d5_uv_photo_galaxy_7dl with dissolve
    pause(2)
    scene bg ext_camp_entrance_sunset_7dl
    show uv surprise2 at center
    with dissolve
    ...
    scene bg ext_washstand_sunset_7dl with fade
    show mt angry panama pioneer at fleft
    with dissolve
    play sound sfx_open_water_sink
    pause(1)
